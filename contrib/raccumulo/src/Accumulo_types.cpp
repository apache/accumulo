    ...
    switch (fid)
    {
      ...
      case 6:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = (ScanType::type)ecast64;
      ...
      case 7:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->state = (ScanState::type)ecast65;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->iterators.resize(_size71);
            uint32_t _i75;
            for (_i75 = 0; _i75 < _size71; ++_i75)
            {
              xfer += this->iterators[_i75].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.iterators = true;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->authorizations.resize(_size76);
            uint32_t _i80;
            for (_i80 = 0; _i80 < _size76; ++_i80)
            {
              xfer += iprot->readBinary(this->authorizations[_i80]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.authorizations = true;
...
uint32_t ActiveScan::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->columns.size()));
    std::vector<Column> ::const_iterator _iter81;
    for (_iter81 = this->columns.begin(); _iter81 != this->columns.end(); ++_iter81)
    {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->iterators.size()));
    std::vector<IteratorSetting> ::const_iterator _iter82;
    for (_iter82 = this->iterators.begin(); _iter82 != this->iterators.end(); ++_iter82)
    {
  ...
  xfer += oprot->writeFieldBegin("authorizations", ::apache::thrift::protocol::T_LIST, 11);
  {
    ...
    for (_iter83 = this->authorizations.begin(); _iter83 != this->authorizations.end(); ++_iter83)
    {
    ...
    switch (fid)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->inputFiles.resize(_size84);
            uint32_t _i88;
            for (_i88 = 0; _i88 < _size84; ++_i88)
            {
              xfer += iprot->readString(this->inputFiles[_i88]);
            }
            xfer += iprot->readListEnd();
          }
      ...
      case 5:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = (CompactionType::type)ecast89;
          this->__isset.type = true;
        } else {
          xfer += iprot->skip(ftype);
        }
      ...
      case 6:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->reason = (CompactionReason::type)ecast90;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->iterators.resize(_size91);
            uint32_t _i95;
            for (_i95 = 0; _i95 < _size91; ++_i95)
            {
              xfer += this->iterators[_i95].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.iterators = true;
...
uint32_t ActiveCompaction::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("inputFiles", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    for (_iter96 = this->inputFiles.begin(); _iter96 != this->inputFiles.end(); ++_iter96)
    {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->iterators.size()));
    std::vector<IteratorSetting> ::const_iterator _iter97;
    for (_iter97 = this->iterators.begin(); _iter97 != this->iterators.end(); ++_iter97)
    {
