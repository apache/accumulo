 ...
 * 10/10 byte key length and 78/78 byte value length. Along with the 10 byte row
 * id and \r\n
 ...
 * 
 * Params <numrows> <minkeylength> <maxkeylength> <minvaluelength>
 * <maxvaluelength> <tablename> <instance> <zoohosts> <username> <password>
 * [rows_per_split]
