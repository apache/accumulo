...
public class RegexExample extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    AccumuloInputFormat.setRegex(job, RegexType.ROW, args[5]);
    AccumuloInputFormat.setRegex(job, RegexType.COLUMN_FAMILY, args[6]);
    AccumuloInputFormat.setRegex(job, RegexType.COLUMN_QUALIFIER, args[7]);
    AccumuloInputFormat.setRegex(job, RegexType.VALUE, args[8]);
