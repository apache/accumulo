...
public class IterUtilTest extends TestCase {
    ...
    public void test1() throws IOException{
		...
		SortedKeyValueIterator<Key,Value> iter = IteratorUtil.loadIterators(IteratorScope.minc, source, new KeyExtent(new Text("tab"), null, null), conf, new DefaultIteratorEnvironment());
    ...
    public void test4() throws IOException{
		...
		SortedKeyValueIterator<Key,Value> iter = IteratorUtil.loadIterators(IteratorScope.majc, source, new KeyExtent(new Text("tab"), null, null), conf, new DefaultIteratorEnvironment());
