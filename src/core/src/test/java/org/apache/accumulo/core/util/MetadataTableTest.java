...
public class MetadataTableTest extends TestCase {
    ...
    private void runTest(String beginRange, String endRange) {
        ...
        children = createKeyExtents(new String[][] {new String[] {"foo", "r1", beginRange},
        ...
        children = createKeyExtents(new String[][] {new String[] {"foo", "r1", beginRange}, new String[] {"foo", "r2", "r1"},
        ...
        children = createKeyExtents(new String[][] {new String[] {"foo", "r1", beginRange}, new String[] {"foo", "r2", null},
                new String[] {"foo", endRange, "r2"}});
