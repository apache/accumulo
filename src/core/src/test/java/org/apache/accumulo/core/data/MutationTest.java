...
public class MutationTest extends TestCase {
     ...
     * the first set of column updates (and value lengths). Hadoop input formats reuse objects when reading, so if Mutations are used with an input format (or
     * as the input to a combiner or reducer) then they will be used in this fashion.
     */
