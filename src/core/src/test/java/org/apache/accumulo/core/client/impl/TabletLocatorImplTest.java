...
public class TabletLocatorImplTest extends TestCase {
	...
	private void runTest(Text tableName, List<Range> ranges,
	...
	public void testBinRanges1() throws Exception{
		...
		expected = 
			createExpectedBinnings(	"l1", 
									nol( nke("foo",null,null), nrl(nr("a",null)) )
		...
		expected = 
			createExpectedBinnings(	"l1", 
									nol( nke("foo",null,null), nrl(nr(null,"b")) )
	...
	public void testBinRanges2() throws Exception{
		...
		Map<String, Map<KeyExtent, List<Range>>> expected = 
			createExpectedBinnings(	"l1", 
									nol( nke("foo","g",null), nrl(nr(null,null)) ),
									"l2", 
	...
	public void testBinRanges3() throws Exception{
		...
		expected = 
			createExpectedBinnings(	"l1",
									nol( nke("foo","g",null), nrl(nr(null,"c")) ),
									"l2",
		...
		expected = 
			createExpectedBinnings(	"l1",
									nol( nke("foo","g",null), nrl(nr(null,"c"), nr("f","i")) ),
									"l2",
		...
		expected = 
			createExpectedBinnings(	"l1",
									nol( nke("foo","g",null), nrl(nr("g", true,"m", true)) ),
									"l2",
		...
		expected = 
			createExpectedBinnings(	"l1",
									nol( nke("foo","g",null), nrl(nr("g", true,"m", false)) ),
									"l2",
	...
	public void testBinRanges4() throws Exception{
		...
		TabletLocatorImpl metaCache = createLocators("foo", nke("foo","0",null), "l1", nke("foo","1","0"), "l2", nke("foo","2","1"), "l3", nke("foo","3","2"), "l4", nke("foo",null,"3"), "l5");
		...
		ranges = nrl(range);
		Map<String, Map<KeyExtent, List<Range>>> expected5 = 
			createExpectedBinnings(	"l4",
									nol( nke("foo","3","2"), nrl(range) ),
									"l5",
		...
		ranges = nrl(range);
		Map<String, Map<KeyExtent, List<Range>>> expected7 = 
			createExpectedBinnings(	"l3",
									nol( nke("foo","2","1"), nrl(range) ),
									"l4",
									nol( nke("foo","3","2"), nrl(range) )
		...
		ranges = nrl(range);
		Map<String, Map<KeyExtent, List<Range>>> expected9 = 
			createExpectedBinnings(	"l3",
									nol( nke("foo","2","1"), nrl(range) ),
									"l4",
									nol( nke("foo","3","2"), nrl(range) )
	...
	public void testBinRanges5() throws Exception{
		...
		List<Range> ranges = nrl(new Range(new Text("1")));
		TabletLocatorImpl metaCache = createLocators("foo", nke("foo","0",null), "l1", nke("foo","1","0"), "l2", nke("foo","3","2"), "l4", nke("foo",null,"3"), "l5");
		...
		Map<String, Map<KeyExtent, List<Range>>> expected4 = 
			createExpectedBinnings(	"l1",
									nol( nke("foo","0",null), nrl(nr("0","1")) ),
									"l2",
									nol( nke("foo","1","0"), nrl(nr("0","1")) ),
									"l4",
									nol( nke("foo","3","2"), nrl(nr("21","4")) ),
									"l5",
