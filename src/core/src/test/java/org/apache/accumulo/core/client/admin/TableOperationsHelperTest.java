...
public class TableOperationsHelperTest {
    ...
    public void testAttachIterator() throws Exception{
        ...
        t.check("table", new String[] {
                "table.iterator.majc.someName=10,foo.bar",
                "table.iterator.majc.someName.opt.key=value",
                "table.iterator.scan.someName=10,foo.bar",
        });
        ...
        t.removeIterator("table", "someName");
        t.check("table", new String[] {
                "table.iterator.majc.otherName=20,some.classname",
        ...
        t.check("foo", new String[]{
                "table.iterator.majc.otherName=20,some.classname",
                "table.iterator.majc.otherName.opt.key=value",
                "table.iterator.minc.otherName=20,some.classname",
                "table.iterator.minc.otherName.opt.a=b",
                "table.iterator.scan.otherName=20,some.classname",
        });
    }
