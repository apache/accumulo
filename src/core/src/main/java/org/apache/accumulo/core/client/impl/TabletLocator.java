...
public abstract class TabletLocator {
	...
	public abstract TabletLocation locateTablet(Text row, boolean skipRow, boolean retry) throws AccumuloException, AccumuloSecurityException, TableNotFoundException;
	
	public abstract void binMutations(List<Mutation> mutations, 
			Map<String, TabletServerMutations> binnedMutations,
			List<Mutation> failures) throws AccumuloException, AccumuloSecurityException, TableNotFoundException; 
	
	public abstract List<Range> binRanges(List<Range> ranges, Map<String, Map<KeyExtent, List<Range>>> binnedRanges) throws AccumuloException, AccumuloSecurityException, TableNotFoundException;
	    ...
	    if (tl == null)
	    {
	    	...
	    	if(tableId.toString().equals(Constants.METADATA_TABLE_ID)){
	    		...
	    		tl = new TabletLocatorImpl(new Text(Constants.METADATA_TABLE_ID), rootTabletLocator, mlo){
	    			public TabletLocation _locateTablet(Text row, boolean skipRow, boolean retry, boolean lock) throws AccumuloException, AccumuloSecurityException, TableNotFoundException{
