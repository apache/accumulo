...
public class ConnectorImpl extends Connector {
    ...
    public BatchDeleter createBatchDeleter(String tableName, Authorizations authorizations, int numQueryThreads, long maxMemory, long maxLatency,
        ...
        ArgumentChecker.notNull(tableName, authorizations);
        return new TabletServerBatchDeleter(instance, credentials, Tables.getTableId(instance, tableName), authorizations, numQueryThreads, maxMemory,
                maxLatency, maxWriteThreads);
    }
