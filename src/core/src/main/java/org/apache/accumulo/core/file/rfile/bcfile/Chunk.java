...
final class Chunk {
     ...
     * Where len1, len2, ..., len_n are the lengths of the data chunks. Non-terminal chunks have their lengths negated. Non-terminal chunks cannot have length
     * 0. All lengths are in the range of 0 to Integer.MAX_VALUE and are encoded in Utils.VInt format.
     */
