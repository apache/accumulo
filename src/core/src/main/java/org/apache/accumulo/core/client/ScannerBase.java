...
/**
 * This class host methods that are shared between all different types of
 * scanners.
 * 
 */
public interface ScannerBase extends Iterable<Entry<Key, Value>> {
     ...
     * 
     * @param iteratorClass
     *            the fully qualified class name of the iterator to be applied
     *            at scan time
     * @param iteratorName
    ...
    /**
     * Update the options for an iterator.  Note that this does <b>not</b> change the
     * iterator options during a scan, it just replaces the given option on a configured
     * iterator before a scan is started.
     * 
    ...
    /**
     * Call this method to initialize regular expressions on a scanner. If it is
     * not called, reasonable defaults will be used.
     * 
     * @param iteratorName
     *            a nickname for the iterator
    ...
    /**
     * 
     * Set a row regular expression that filters non matching entries server
     * side.
     * 
     * @param regex
    ...
    /**
     * 
     * Set a column family regular expression that filters non matching entries
     * server side.
     * 
     * @param regex
     *            java regular expression to match
     ...
     * 
     * Set a column qualifier regular expression that filters non matching
     * entries server side.
     * 
     * @param regex
     *            java regular expression to match
    ...
    /**
     * Set a value regular expression that filters non matching entries server
     * side.
     * 
     * @param regex
     *            java regular expression to match
    ...
    /**
     * @param col
     *            limit the scan to only this column family (multiple calls
     *            appends to the list of column families to limit)
     */
    public void fetchColumnFamily(Text col);

    /**
     * Limits the scan to only this column, identified by family and qualifier.
     * Multiple calls appends to the list of columns to be fetched.
     * 
     * @param colFam
    ...
    /**
     * Clears the columns to be fetched (useful for resetting the scanner for
     * reuse)
     */
