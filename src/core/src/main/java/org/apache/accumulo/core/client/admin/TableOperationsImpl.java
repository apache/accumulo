...
public class TableOperationsImpl extends TableOperations {
	...
	public Map<String, Set<Text>> getLocalityGroups(String tableName) throws AccumuloException, TableNotFoundException {
		Map<String, Set<ByteSequence>> groups = LocalityGroupUtil.getLocalityGroups(AccumuloConfiguration.getTableConfiguration(instance.getInstanceID(), Tables.getTableId(instance, tableName)));
