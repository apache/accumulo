...
public enum Property
{
	...
	INSTANCE_DFS_URI("instance.dfs.uri","",
			PropertyType.URI,
    ...
    MASTER_BULK_SERVERS("master.bulk.server.max", "4", PropertyType.COUNT,
            "The number of servers to use during a bulk load"),
    ...
    MASTER_MINTHREADS("master.server.threads.minimum", "2", PropertyType.COUNT,
	...
	TSERV_SCAN_MAX_OPENFILES("tserver.scan.files.open.max","100",
			PropertyType.COUNT,
	...
	TSERV_MINTHREADS("tserver.server.threads.minimum", "2", PropertyType.COUNT,
            "The miniumum number of threads to use to handle incoming requests."), 
	...
	LOGGER_MINTHREADS("logger.server.threads.minimum", "2", PropertyType.COUNT,
            "The miniumum number of threads to use to handle incoming requests."), 
    LOGGER_THREADCHECK("logger.server.threadcheck.time", "1s", PropertyType.TIMEDURATION, 
            "The time between adjustments of the server thread pool."),
	...
	TABLE_SCAN_MAXMEM("table.scan.max.memory","1M",
			PropertyType.MEMORY,
	...
	TABLE_FILE_MAX("table.file.max","15",
			PropertyType.COUNT,
    ...
    private static final EnumSet<Property> fixedProperties = 
    	EnumSet.of(Property.TSERV_CLIENTPORT, 
    		...
    		Property.TSERV_MAJC_THREAD_MAXOPEN,
