...
public class MapFileUtil {
	...
	public static MyMapFile.Reader openMapFile(AccumuloConfiguration acuconf, FileSystem fs, String dirName, Configuration conf)
	throws IOException
	{
	...
	public static MySequenceFile.Reader openIndex(Configuration conf, FileSystem fs, Path mapFile)
	throws IOException
	{
	...
	public static MyMapFile.Writer openMapFileWriter(AccumuloConfiguration acuTableConf, Configuration conf, FileSystem fs, String dirname)
	throws IOException
	{
