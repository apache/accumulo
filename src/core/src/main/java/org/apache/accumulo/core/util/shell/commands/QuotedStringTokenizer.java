 ...
 * It understands quoted strings and escaped quote characters.
 * 
 * You can use the escape sequence '\' to escape single quotes,
 * double quotes, and spaces only, in addition to the escape character itself.
 * 
 * The behavior is the same for single and double quoted strings.
 * (i.e. '\'' is the same as "\'")
 */
