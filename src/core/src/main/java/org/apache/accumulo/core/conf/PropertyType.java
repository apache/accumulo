...
public enum PropertyType
{
	...
	DATETIME("date/time","(?:19|20)\\d{12}[A-Z]{3}",
	...
	CLASSNAME("java class","[\\w$.]*",
			"A fully qualified java class name representing a class on the classpath.<br />" +
	...
	String getFormatDescription() { return format; }
	public boolean isValidFormat(String value) { return (regex == null && value == null) ? true : regex.matcher(value).matches(); }
}
