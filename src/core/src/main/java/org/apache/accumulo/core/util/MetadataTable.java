...
public class MetadataTable
{
    ...
    public static void getEntries(Instance instance, AuthInfo credentials, String table, boolean isTid, Map<KeyExtent, String> locations, SortedSet<KeyExtent> tablets)
	...
	public static void validateEntries(String tableId, SortedSet<KeyExtent> tablets)
