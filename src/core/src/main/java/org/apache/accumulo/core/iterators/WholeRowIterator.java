 ...
 * 
 * <p>One caveat is that when seeking in the WholeRowIterator using a range that starts at a non-inclusive 
 ...
 * automatically creates ranges of that form, which happens in the case of the client calling continueScan, 
 * or in the case of the tablet server continuing a scan after swapping out sources.
 * 
 * <p>To regain the original key/value pairs of the row, call the decodeRow function on the key/value pair
 * that this iterator returned.
 *
 */
