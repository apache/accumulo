...
public class AccumuloOutputFormat extends OutputFormat<Text,Mutation> {
    ...
    private static class AccumuloRecordWriter extends RecordWriter<Text,Mutation> {
        ...
        /**
         * Push a mutation into a table. If table is null, the defaultTable will be used. If canCreateTable is set, the table will be created if it does not
         * exist. The table name must only contain alphanumerics and underscore.
         */
        @Override
