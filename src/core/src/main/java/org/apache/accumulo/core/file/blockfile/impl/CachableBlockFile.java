...
public class CachableBlockFile {
    ...
    public static class Reader implements BlockFileReader {
        ...
        /**
         * It is intended that once the BlockRead object is returned to the caller, that the caller will read the entire block and then call close on the
         * BlockRead class.
         * 
         * NOTE: In the case of multi-read threads: This method can do redundant work where an entry is read from disk and other threads check the cache before
    ...
    public static class BlockRead extends DataInputStream implements ABlockReader {
        ...
        /**
         * It is intended that the caller of this method will close the stream we also only intend that this be called once per BlockRead. This method is
         * provide for methods up stream that expect to receive a DataInputStream object.
         */
        @Override
