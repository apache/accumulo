        ...
        public void seek(Range range, Collection<ByteSequence> columnFamilies, boolean inclusive) throws IOException {
            ...
            for (LocalityGroupReader lgr : lgReaders) {
                ...
                if (cfSet.size() == 0) {
                    ...
                    /*
                     * Need to consider the following cases for inclusive and exclusive (lgcf:locality group column family set, cf:column family set) lgcf and
                     * cf are disjoint lgcf and cf are the same cf contains lgcf lgcf contains cf lgccf and cf intersect but neither is a subset of the other
                     */
