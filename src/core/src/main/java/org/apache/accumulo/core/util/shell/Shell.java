...
public class Shell {
    ...
    public void config(String... args) {
		...
		Command external[] = {
                ...
                new DebugCommand(),  
                new DeleteCommand(),  
                new DeleteIterCommand(),  
                new DeleteManyCommand(),  
                new DeleteRowsCommand(),  
                new DeleteScanIterCommand(),  
                ...
                new InfoCommand(),  
                new InsertCommand(),  
                new ListScansCommand(),  
                new MasterStateCommand(),  
                new MaxRowCommand(),  
                new MergeCommand(),  
                new NoTableCommand(),  
                new OfflineCommand(),  
                ...
                new ScanCommand(),  
                new SelectCommand(),  
                new SelectrowCommand(),  
                new SetAuthsCommand(),  
                new SetGroupsCommand(),  
                new SetIterCommand(),  
                new SetScanIterCommand(),  
                new SleepCommand(),  
