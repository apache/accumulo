...
public class UpdateErrors implements TBase<UpdateErrors, UpdateErrors._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    ...
    tmpMap.put(_Fields.FAILED_EXTENTS, new FieldMetaData("failedExtents", TFieldRequirementType.DEFAULT, 
    ...
    tmpMap.put(_Fields.AUTHORIZATION_FAILURES, new FieldMetaData("authorizationFailures", TFieldRequirementType.DEFAULT, 
        new ListMetaData(TType.LIST, 
            new StructMetaData(TType.STRUCT, TKeyExtent.class))));
  ...
  public UpdateErrors(
    java.util.Map<TKeyExtent,Long> failedExtents,
  ...
  public int compareTo(UpdateErrors other) {
    ...
    if (isSetFailedExtents()) {      lastComparison = TBaseHelper.compareTo(this.failedExtents, typedOther.failedExtents);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetAuthorizationFailures()) {      lastComparison = TBaseHelper.compareTo(this.authorizationFailures, typedOther.authorizationFailures);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
