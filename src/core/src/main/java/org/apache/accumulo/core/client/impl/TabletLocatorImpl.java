...
public class TabletLocatorImpl extends TabletLocator {
	...
	public static interface TabletLocationObtainer {
		...
		List<TabletLocation> lookupTablets(String tserver, Map<KeyExtent, List<Range>> map, TabletLocator parent) throws AccumuloSecurityException, AccumuloException;
	}
	...
	@Override
	public void binMutations(List<Mutation> mutations, Map<String, TabletServerMutations> binnedMutations, List<Mutation> failures) throws AccumuloException, AccumuloSecurityException, TableNotFoundException {
	...
	private void addMutation(
			...
			Mutation mutation, TabletLocation tl) {
	...
	private List<Range> binRanges(List<Range> ranges, Map<String, Map<KeyExtent, List<Range>>> binnedRanges, boolean useCache) throws AccumuloException, AccumuloSecurityException, TableNotFoundException {
	...
	@Override
	public List<Range> binRanges(List<Range> ranges, Map<String, Map<KeyExtent, List<Range>>> binnedRanges) throws AccumuloException, AccumuloSecurityException, TableNotFoundException {
		...
		throws AccumuloException, AccumuloSecurityException, TableNotFoundException 
	{
		...
		OpTimer opTimer = null;
		if(log.isTraceEnabled())
			opTimer = new OpTimer(log, Level.TRACE).start("Locating tablet  table="+tableId+" row="+TextUtil.truncate(row)+"  skipRow="+skipRow+" retry="+retry);
	...
	protected TabletLocation _locateTablet(Text row, boolean skipRow, boolean retry, boolean lock) throws AccumuloException, AccumuloSecurityException, TableNotFoundException 
	{
