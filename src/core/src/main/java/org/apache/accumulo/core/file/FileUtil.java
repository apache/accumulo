...
public class FileUtil {
	...
	private static String createTmpDir(FileSystem fs)
	throws IOException
	{
	...
	public static Collection<String> reduceFiles(Configuration conf, FileSystem fs, Text prevEndRow, Text endRow, Collection<String> mapFiles, int maxFiles, String tmpDir, int pass)
	throws IOException
	{
	...
	public static SortedMap<Double, Key> findMidPoint(Text prevEndRow, Text endRow, Collection<String> mapFiles, double minSplit)
	throws IOException
	{
	...
	private static void cleanupIndexOp(String tmpDir, FileSystem fs,
	...
	private static long countIndexEntries(Text prevEndRow, Text endRow,
			Collection<String> mapFiles, boolean useIndex, Configuration conf,
			FileSystem fs, AccumuloConfiguration acuconf,
	...
	public static WritableComparable<Key> findLastKey(Collection<String> mapFiles)
	throws IOException
	{
		Configuration conf = CachedConfiguration.getInstance();
		FileSystem fs = FileSystem.get(conf);
	...
	public static Map<KeyExtent, Long> estimateSizes(Path mapFile, long fileSize, List<KeyExtent> extents, Configuration conf, FileSystem fs)
	throws IOException
	{
