 ...
 * @deprecated Use {@link org.apache.accumulo.core.file.rfile.RFile}
 */
...
public class MySequenceFile {
     ...
     * @deprecated Use the one of the many MySequenceFile.createWriter methods to specify the {@link CompressionType} while creating the {@link MySequenceFile}
    ...
    public static class Writer implements java.io.Closeable {
        ...
        public Writer(FileSystem fs, Configuration conf, Path name, Class keyClass, Class valClass, Progressable progress, Metadata metadata)
                throws IOException {
        ...
        void init(Path name, Configuration conf, FSDataOutputStream out, Class keyClass, Class valClass, boolean compress, CompressionCodec codec,
         ...
         * 
         * <p>
         * This always returns a synchronized position. In other words, immediately after calling {@link MySequenceFile.Reader#seek(long)} with a position
         * returned by this method, {@link MySequenceFile.Reader#next(Writable)} may be called. However the key may be earlier in the file than key last written
         * when this method was called (e.g., with block-compression, it may be the first key in the block that was being written when this method was called).
         */
    ...
    static class BlockCompressWriter extends Writer {
        ...
        /** Create the named file with write-progress reporter. */
        public BlockCompressWriter(FileSystem fs, Configuration conf, Path name, Class keyClass, Class valClass, int bufferSize, short replication,
                long blockSize, CompressionCodec codec, Progressable progress, Metadata metadata) throws IOException {
            super.init(name, conf, fs.create(name, true, bufferSize, replication, blockSize, progress), keyClass, valClass, true, codec, metadata);
    ...
    public static class Reader implements java.io.Closeable {
         ...
         * 
         * @param tmpReader
         *            <code>true</code> if we are constructing a temporary reader {@link MySequenceFile.Sorter.cloneFileAttributes}, and hence do not initialize
         *            every component; <code>false</code> otherwise.
         * @throws IOException
         */
        ...
        /**
         * Read the next key/value pair in the file into <code>buffer</code>. Returns the length of the key read, or -1 if at end of file. The length of the
         * value may be computed by calling buffer.getLength() before and after calls to this method.
         */
         ...
         * 
         * <p>
         * The position passed must be a position returned by {@link MySequenceFile.Writer#getLength()} when writing this file. To seek to an arbitrary
    ...
    public static class Sorter {
        ...
        public Writer cloneFileAttributes(Path inputFile, Path outputFile, Progressable prog) throws IOException {
            ...
            Writer writer = createWriter(outputFile.getFileSystem(conf), conf, outputFile, keyClass, valClass, compress, blockCompress, codec, prog,
                    new Metadata());
            return writer;
        }
        ...
        /**
         * This class defines a merge segment. This class can be subclassed to provide a customized cleanup method implementation. In this implementation,
         * cleanup closes the file handle and deletes the file
         */
