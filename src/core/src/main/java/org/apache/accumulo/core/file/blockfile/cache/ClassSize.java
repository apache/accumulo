...
public class ClassSize {
    ...
    /**
     * The estimate of the size of a class instance depends on whether the JVM uses 32 or 64 bit addresses, that is it depends on the size of an object
     * reference. It is a linear function of the size of a reference, e.g. 24 + 5*r where r is the size of a reference (usually 4 or 8 bytes).
     * 
     ...
     * object. So the estimated size of an array field does not depend on the size of the array. Similarly the size of an object (reference) field does not
