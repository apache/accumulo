...
public class ClassSize {
  ...
  static {
    ...
    ARRAYLIST = align(OBJECT + align(REFERENCE) + align(ARRAY) +
        (2 * SizeConstants.SIZEOF_INT));
    
    BYTE_BUFFER = align(OBJECT + align(REFERENCE) + align(ARRAY) + 
        (5 * SizeConstants.SIZEOF_INT) + 
    ...
    CONCURRENT_HASHMAP = align((2 * SizeConstants.SIZEOF_INT) + ARRAY + 
        (6 * REFERENCE) + OBJECT);
    ...
    CONCURRENT_HASHMAP_SEGMENT = align(REFERENCE + OBJECT + 
        (3 * SizeConstants.SIZEOF_INT) + SizeConstants.SIZEOF_FLOAT + ARRAY);
