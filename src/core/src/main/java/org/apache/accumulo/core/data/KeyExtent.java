...
public class KeyExtent implements WritableComparable<KeyExtent> {
    ...
    public KeyExtent(TKeyExtent tke){
    	this.setTableId(new Text(tke.table));
    	this.setEndRow(tke.endRow == null ? null : new Text(tke.endRow), false, false);
    	this.setPrevEndRow(tke.prevEndRow == null ? null : new Text(tke.prevEndRow), false, false);
    ...
    public TKeyExtent toThrift(){
    	return new TKeyExtent(TextUtil.getBytes(textTableId), 
    			textEndRow == null ? null : TextUtil.getBytes(textEndRow),
    			textPrevEndRow == null ? null : TextUtil.getBytes(textPrevEndRow));
    }
}
