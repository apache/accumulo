...
public class UpgradeMetadataTable {
	...
	public static void main(String[] args) throws Exception {
		...
		FileSKVWriter defaultTabletFile = FileOperations.getInstance().openWriter(ServerConstants.getMetadataTableDir()+"_new"+"/default_tablet/00000_00000.rf", fs, conf, AccumuloConfiguration.getDefaultConfiguration());
		...
		FileSKVWriter rootTabletFile = FileOperations.getInstance().openWriter(ServerConstants.getMetadataTableDir()+"_new"+"/root_tablet/00000_00000.rf", fs, conf, AccumuloConfiguration.getDefaultConfiguration());
