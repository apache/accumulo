...
public class TServerUtils {
    ...
    public static TServer startTServer(TProcessor processor, 
        ...
        final TServer tserver = new TThreadPoolServer(new ClientInfoProcessorFactory(processor), 
                                                      serverTransport,
                                                      ThriftUtil.transportFactory(), 
                                                      ThriftUtil.transportFactory(),
                                                      ThriftUtil.inputProtocolFactory(), 
                                                      ThriftUtil.outputProtocolFactory(),
                                                      options);
