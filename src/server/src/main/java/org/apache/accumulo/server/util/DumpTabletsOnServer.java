...
public class DumpTabletsOnServer {
  ...
  public static void main(String[] args) throws Exception {
    ...
    List<TabletStats> onlineTabletsForTable = ThriftUtil.getTServerClient(args[0], AccumuloConfiguration.getSystemConfiguration()).getTabletStats(null,
        SecurityConstants.systemCredentials, tableId);
