...
public class Monitor {
	...
	private static class MaxList<T> extends LinkedList<Pair<Long, T>>{
	    ...
	    public MaxList(long maxDelta) { this.maxDelta = maxDelta; }
	    @Override
	...
	private static GCStatus fetchGcStatus() {
		...
		try {
			...
			ZooKeeper zk = new ZooKeeper(zooKeepers, (int) AccumuloConfiguration.getSystemConfiguration().getTimeInMillis(Property.INSTANCE_ZK_TIMEOUT), new Watcher() {
				@Override
