...
public class ContinuousScanner {
	...
	public static void main(String[] args) throws Exception {
		...
		if(args.length != 9){
			throw new IllegalArgumentException("usage : "+ContinuousScanner.class.getName()+" [--debug <debug log>] <instance name> <zookeepers> <user> <pass> <table> <min> <max> <sleep time> <num to scan>");
		}
