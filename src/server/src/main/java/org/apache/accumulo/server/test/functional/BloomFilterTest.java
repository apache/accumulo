...
public class BloomFilterTest extends FunctionalTest {
	...
	public List<TableSetup> getTablesToCreate() {
		...
		//tl.add(new TableSetup("bt3",parseConfig(Property.TABLE_BLOOM_ENABLED+"=true", Property.TABLE_BLOOM_KEYDEPTH+"="+PartialKey.ROW_COLFAM_COLQUAL.name())));
		...
		tl.add(new TableSetup("bt1",parseConfig(Property.TABLE_BLOOM_ENABLED+"=true", Property.TABLE_BLOOM_KEY_FUNCTOR+"=org.apache.accumulo.core.file.keyfunctor.RowFunctor")));
		tl.add(new TableSetup("bt2",parseConfig(Property.TABLE_BLOOM_ENABLED+"=true", Property.TABLE_BLOOM_KEY_FUNCTOR+"=org.apache.accumulo.core.file.keyfunctor.ColumnFamilyFunctor")));
		tl.add(new TableSetup("bt3",parseConfig(Property.TABLE_BLOOM_ENABLED+"=true", Property.TABLE_BLOOM_KEY_FUNCTOR+"=org.apache.accumulo.core.file.keyfunctor.ColumnQualifierFunctor")));
		tl.add(new TableSetup("bt4",parseConfig(Property.TABLE_BLOOM_ENABLED+"=true", Property.TABLE_BLOOM_KEY_FUNCTOR+"=org.apache.accumulo.core.file.keyfunctor.RowFunctor")));
		return tl;
	}
	...
	public void run() throws Exception {
		...
		bw.addMutation(m);
		bw.close();
		getConnector().tableOperations().flush("bt4");
	...
	private void write(String table, int depth, long start, long end, int step) throws Exception {
		...
		getConnector().tableOperations().flush(table);
	}
}
