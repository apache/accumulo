...
public class Admin
{
	...
	public static void main(String[] args)
	{
	    ...
	    try {
	        ...
	        h.printHelp(new PrintWriter(str), h.getWidth(), Admin.class.getName()+" stopMaster | stopAll | stop <tserver>", null, opts, h.getLeftPadding(), h.getDescPadding(), null, true);
	    	if (cl != null && cl.hasOption("?"))
	    		log.info(str.toString());
	    	else 
	    		log.error(str.toString());
	        h.printHelp(new PrintWriter(System.err), h.getWidth(), Admin.class.getName()+" stopMaster | stopAll | stop <tserver>", null, opts, h.getLeftPadding(), h.getDescPadding(), null, true);
	        System.exit(3);
	    }
	...
	private static void stopServer(AuthInfo credentials, boolean tabletServersToo)
	...
	private static void stopTabletServer(String server)
    throws AccumuloException, AccumuloSecurityException
    {
        MasterClientService.Iface client = connect();
