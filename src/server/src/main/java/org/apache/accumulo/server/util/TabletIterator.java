 ...
 *
 * If a tablet that was returned by this iterator is 
 * subsequently deleted from the metadata table, then
 * this iterator will throw a TabletDeletedException.
 * This could occur when a table is merged.
 * 
 *
 */
