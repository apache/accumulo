...
public class Initialize
{
    ...
    private static void initFileSystem(FileSystem fs, Configuration conf, UUID uuid) throws IOException
    {
        ...
        try {
            ...
            // metadata tablets
            String initRootTabFile = Constants.getMetadataTableDir() + "/root_tablet/00000_00000." + FileOperations.getNewFileExtension(AccumuloConfiguration.getSystemConfiguration());
