...
public class ScanIteratorTest extends FunctionalTest {
  ...
  private void setupIter(ScannerBase scanner) throws Exception {
    scanner.setScanIterators(50, "org.apache.accumulo.server.test.functional.DropModIter", "dropMod");
    scanner.setScanIteratorOption("dropMod", "mod", "2");
    scanner.setScanIteratorOption("dropMod", "drop", "0");
  }
