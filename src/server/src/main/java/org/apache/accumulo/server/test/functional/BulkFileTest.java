...
public class BulkFileTest extends FunctionalTest {
	...
	public void run() throws Exception {
		...
		FileSKVWriter writer1 = FileOperations.getInstance().openWriter(dir+"/f1."+MyMapFile.EXTENSION, fs, conf, AccumuloConfiguration.getSystemConfiguration());
		...
		FileSKVWriter writer2 = FileOperations.getInstance().openWriter(dir+"/f2."+MyMapFile.EXTENSION, fs, conf, AccumuloConfiguration.getSystemConfiguration());
