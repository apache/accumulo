...
public class RowDeleteTest extends FunctionalTest {
    ...
    public Map<String,String> getInitialConfig() {
        ...
        conf.put(Property.TSERV_MAJC_DELAY.getKey(), "1");
        return conf;
    }
    ...
    public List<TableSetup> getTablesToCreate() {
        TableSetup ts1 = new TableSetup("rdel1", parseConfig(Property.TABLE_LOCALITY_GROUPS + "=lg1,dg", Property.TABLE_LOCALITY_GROUP_PREFIX + "lg1=foo",
                Property.TABLE_LOCALITY_GROUP_PREFIX + "dg=", Property.TABLE_ITERATOR_PREFIX + "" + IteratorScope.majc + ".rdel=30,"
                        + RowDeletingIterator.class.getName(), Property.TABLE_MAJC_RATIO + "=100"));
    ...
    public void run() throws Exception {
        ...
        bw.flush();
        getConnector().tableOperations().flush("rdel1");
        ...
        getConnector().tableOperations().setProperty("rdel1", Property.TABLE_MAJC_COMPACTALL_AT.getKey(), nowStr);
