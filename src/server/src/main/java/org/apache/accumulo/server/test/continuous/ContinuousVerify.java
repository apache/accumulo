...
/**
 * A map reduce job that verifies a table created by continuous
 * ingest.  It verifies that all referenced nodes are defined.
 */
...
public class ContinuousVerify extends Configured implements Tool
{
    ...
    public int run(String[] args) throws IOException, InterruptedException, ClassNotFoundException
    {
        ...
        // set up ranges
        try {
        	Set<Range> ranges = new ZooKeeperInstance(instance, zookeepers).getConnector(user, pass.getBytes()).tableOperations().splitRangeByTablets(table, new Range(), Integer.parseInt(maxMaps));
