...
public class LogService implements MutationLogger.Iface, Watcher {
    ...
    void registerInZooKeeper(String name) throws KeeperException, InterruptedException {
        ...
        path += "/logger-";
        path = zooKeeper.create(path, name.getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE,
    ...
    @Override
    public void log(TInfo info, long id, long seq, int tid, TMutation mutation) throws NoSuchLogIDException,
            TException {
