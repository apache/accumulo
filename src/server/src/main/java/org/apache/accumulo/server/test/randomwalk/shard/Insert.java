...
public class Insert extends Test {
    ...
    static String insertRandomDocument(long did, BatchWriter dataWriter, BatchWriter indexWriter, String indexTableName, String dataTableName,
            int numPartitions, Random rand) throws TableNotFoundException, Exception, AccumuloException, AccumuloSecurityException {
