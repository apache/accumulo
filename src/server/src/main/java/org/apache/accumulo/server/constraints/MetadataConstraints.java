...
public class MetadataConstraints implements Constraint {
    ...
    private static final HashSet<ColumnFQ> validColumnQuals = new HashSet<ColumnFQ>(Arrays.asList(
			new ColumnFQ[]{
                    ...
                    Constants.METADATA_FLUSH_COLUMN,
                    Constants.METADATA_COMPACT_COLUMN
			}));
	
    private static final HashSet<Text> validColumnFams = new HashSet<Text>(Arrays.asList(
			new Text[]{
			        Constants.METADATA_BULKFILE_COLUMN_FAMILY,
					Constants.METADATA_LOG_COLUMN_FAMILY,
					Constants.METADATA_SCANFILE_COLUMN_FAMILY,
					Constants.METADATA_DATAFILE_COLUMN_FAMILY,
					Constants.METADATA_CURRENT_LOCATION_COLUMN_FAMILY,
					Constants.METADATA_LAST_LOCATION_COLUMN_FAMILY,
                    Constants.METADATA_FUTURE_LOCATION_COLUMN_FAMILY,
                    Constants.METADATA_CHOPPED_COLUMN_FAMILY,
                    Constants.METADATA_CLONED_COLUMN_FAMILY
			}));
