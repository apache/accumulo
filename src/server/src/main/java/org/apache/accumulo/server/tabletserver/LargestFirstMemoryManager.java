...
public class LargestFirstMemoryManager implements MemoryManager {
	...
	LargestFirstMemoryManager(){
		this(ServerConfiguration.getSystemConfiguration().getMemoryInBytes(Property.TSERV_MAXMEM),
				ServerConfiguration.getSystemConfiguration().getCount(Property.TSERV_MINC_MAXCONCURRENT),
