...
public class TableOp extends Test {
	...
	public void visit(State state, Properties props) throws Exception 
	{
		...
		case READ:
			...
			{
				if (re.getCause() instanceof AccumuloSecurityException && ((AccumuloSecurityException) re.getCause()).getErrorCode().equals(SecurityErrorCode.PERMISSION_DENIED))
				{
					if (canRead)
		...
		case BULK_IMPORT:
			...
			FileSKVWriter f = FileOperations.getInstance().openWriter(dir + "/securityBulk."+RFile.EXTENSION, fs, fs.getConf(), AccumuloConfiguration.getDefaultConfiguration());
