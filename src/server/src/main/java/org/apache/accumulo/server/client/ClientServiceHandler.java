...
public class ClientServiceHandler implements ClientService.Iface
{
    ...
    @Override
    public String prepareBulkImport(TInfo info, AuthInfo credentials, String dir, String tableName, double errPercent)
    ...
    @Override
    public void finishBulkImport(TInfo tinfo, AuthInfo credentials, String tableName, String lockFile, boolean disableGC)
            throws ThriftSecurityException, ThriftTableOperationException,
            TException {
        String tableId = checkTableId(tableName, TableOperation.PERMISSION);
        try {
