...
public class ClientServiceHandler implements ClientService.Iface
{
    ...
    @Override
    public void grantTablePermission(TInfo tinfo, AuthInfo credentials, String user, String tableName, byte permission) throws ThriftSecurityException, ThriftTableOperationException
    {
    ...
    @Override
    public void revokeTablePermission(TInfo tinfo, AuthInfo credentials, String user, String tableName, byte permission) throws ThriftSecurityException, ThriftTableOperationException
    {
        String tableId = checkTableId(tableName, TableOperation.PERMISSION);
        try {
    ...
    @Override
    public boolean hasTablePermission(TInfo tinfo, AuthInfo credentials, String user, String tableName, byte tblPerm) throws ThriftSecurityException, ThriftTableOperationException
    {
        String tableId = checkTableId(tableName, TableOperation.PERMISSION);
        try {
    ...
    @Override
    public List<String> bulkImportFiles(TInfo tinfo, final AuthInfo credentials, final long tid, final String tableId, final List<String> files, final String errorDir, final boolean setTime)
    ...
    @Override
    public boolean checkClass(TInfo tinfo, String className, String interfaceMatch)
            throws TException {
