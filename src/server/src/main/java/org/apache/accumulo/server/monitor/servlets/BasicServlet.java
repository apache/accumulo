...
abstract public class BasicServlet extends HttpServlet {
	...
	protected void pageStart(HttpServletRequest req, HttpServletResponse resp, StringBuilder sb) throws Exception {
		...
		sb.append("<div id='subheader'>Instance&nbsp;Name:&nbsp;").append(HdfsZooInstance.getInstance().getInstanceName()).append("&nbsp;&nbsp;&nbsp;Version:&nbsp;").append(Constants.VERSION).append("\n");
		sb.append("<br><span class='smalltext'>Instance&nbsp;ID:&nbsp;").append(HdfsZooInstance.getInstance().getInstanceID()).append("</span></div>\n");
