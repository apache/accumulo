 ...
 * directories within a directory. The primary purpose of this class is to merge
 * the results of multiple Reduce jobs that result in Map output files.
 */
...
public class MultiReader {
    ...
    public MultiReader(FileSystem fs, Configuration conf, String directory)
            throws IOException {
    ...
    public synchronized boolean seek(WritableComparable key) throws IOException {
        ...
        for (Object obj : heap) {
            ...
            try {
                WritableComparable found = 
                    index.reader.getClosest(key, index.value, true);
