...
public class ShardFixture extends Fixture {
  ...
  public void setUp(State state) throws Exception {
    ...
    conn.tableOperations().create((String) state.get("docTableName"));
    conn.tableOperations().addSplits((String) state.get("docTableName"), genSplits(0xff, rand.nextInt(32) + 1, "%02x"));
