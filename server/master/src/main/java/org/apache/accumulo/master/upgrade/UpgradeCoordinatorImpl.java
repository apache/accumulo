...
class UpgradeCoordinatorImpl implements UpgradeCoordinator {

  private static Logger log = LoggerFactory.getLogger(UpgradeCoordinatorImpl.class);
  ...
  UpgradeCoordinatorImpl(int currentVersion, ServerContext ctx) {
