  ...
  public void executeFateOperation(TInfo tinfo, TCredentials c, long opid, FateOperation op,
    ...
    switch (op) {
      ...
      case NAMESPACE_RENAME: {
        ...
        Namespace.ID namespaceId = ClientServiceHandler.checkNamespaceId(master.getContext(), oldName, tableOp);
      ...
      case NAMESPACE_DELETE: {
        ...
        Namespace.ID namespaceId = ClientServiceHandler.checkNamespaceId(master.getContext(), namespace,
            tableOp);
      ...
      case TABLE_CREATE: {
        ...
        try {
          namespaceId = Namespaces.getNamespaceId(master.getContext(), Tables.qualify(tableName).getFirst());
      ...
      case TABLE_RENAME: {
        ...
        Table.ID tableId = ClientServiceHandler.checkTableId(master.getContext(), oldTableName, tableOp);
      ...
      case TABLE_DELETE: {
        ...
        final Table.ID tableId = ClientServiceHandler.checkTableId(master.getContext(), tableName, tableOp);
        Namespace.ID namespaceId = getNamespaceIdFromTableId(tableOp, tableId);
      ...
      case TABLE_EXPORT: {
        ...
        Table.ID tableId = ClientServiceHandler.checkTableId(master.getContext(), tableName, tableOp);
        Namespace.ID namespaceId = getNamespaceIdFromTableId(tableOp, tableId);
