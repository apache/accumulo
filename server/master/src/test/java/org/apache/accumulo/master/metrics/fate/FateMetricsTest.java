...
public class FateMetricsTest {
  ...
  public void init() throws Exception {
    ...
    zooStore = new ZooStore<>(MOCK_ZK_ROOT + Constants.ZFATE, ZooReaderWriter.getInstance());

    master = EasyMock.createMock(Master.class);
    ServerConfigurationFactory cf = EasyMock.createMock(ServerConfigurationFactory.class);
    ...
    AccumuloConfiguration accumuloConfiguration = EasyMock.createMock(AccumuloConfiguration.class);
