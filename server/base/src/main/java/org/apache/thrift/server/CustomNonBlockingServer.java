...
public class CustomNonBlockingServer extends THsHaServer {
  ...
  protected boolean startThreads() {
    ...
    try {
      ...
      SelectAcceptThread selectAcceptThread_ = new CustomerSelectAcceptThread((TNonblockingServerTransport)serverTransport_);
  ...
  private class CustomerSelectAcceptThread extends SelectAcceptThread {
    ...
    public CustomerSelectAcceptThread(TNonblockingServerTransport serverTransport) throws IOException {
