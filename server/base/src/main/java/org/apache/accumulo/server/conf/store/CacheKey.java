 ...
 */
public abstract class CacheKey implements Comparable<CacheKey> {
  ...
  protected CacheKey(final InstanceId instanceId, final String path, final AbstractId<?> id) {
   ...
   */
  public static @Nullable CacheKey fromPath(final String path) {
  ...
  public int compareTo(@NonNull CacheKey other) {
    return Comparator.comparing(CacheKey::getPath).compare(this, other);
  }
