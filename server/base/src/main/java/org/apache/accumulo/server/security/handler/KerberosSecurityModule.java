...
public class KerberosSecurityModule extends ZKSecurityModuleImpl {
  ...
  @Override
  public Auth auth() {
    return new KerberosAuthImpl(context, zooCache, ZKUserPath);
  }

  @Override
  public Policy policy() {
    return new KerberosPolicyImpl(context, zooCache, ZKUserPath);
  }
}
