...
import static org.apache.accumulo.core.fate.zookeeper.ZooAclUtil.checkWritableAuth;
import static org.apache.accumulo.core.fate.zookeeper.ZooAclUtil.extractAuthName;
import static org.apache.accumulo.core.fate.zookeeper.ZooAclUtil.translateZooPerm;
...
import org.apache.accumulo.core.fate.zookeeper.ZooAclUtil;
  ...
  private void printAcls(final InstanceId iid, final Opts opts, final PrintWriter writer) {
    ...
    aclMap.forEach((path, acl) -> {
      if (acl == null) {
        ...
        String otherUpdate;
        if (aclStatus.anyMayUpdate() || aclStatus.anyCanRead()) {
