...
public class RecoveryPathTest {
  ...
  private static void assertBothValid(String input, String expectedOutput) {
    Path hadoopResult = RecoveryPath.getRecoveryPath(new Path(input));
  ...
  private static void assertBothInvalid(String input, String messageContains) {
    var error = assertThrows(IllegalArgumentException.class,
        () -> RecoveryPath.getRecoveryPath(new Path(input)),
  ...
  @Test
  public void testOldWalFormats() {
    assertBothValid("hdfs://nn1/accumulo/wal/" + UUID, "hdfs://nn1/accumulo/recovery/" + UUID);
  }
  ...
  public void testVerifyResultsAreIdentical() {
    ...
    for (String path : validPaths) {
      String hadoopResult = RecoveryPath.getRecoveryPath(new Path(path)).toString();
  ...
  public void testRejectionsAreIdentical() {
    ...
    for (String path : invalidPaths) {
      assertThrows(IllegalArgumentException.class,
          () -> RecoveryPath.getRecoveryPath(new Path(path)),
