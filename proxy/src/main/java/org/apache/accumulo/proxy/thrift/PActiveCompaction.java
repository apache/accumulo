...
@SuppressWarnings("all") public class PActiveCompaction implements org.apache.thrift.TBase<PActiveCompaction, PActiveCompaction._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PActiveCompaction");
  ...
  static {
    schemes.put(StandardScheme.class, new PActiveCompactionStandardSchemeFactory());
   ...
   */
  public PCompactionReason reason; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.TYPE, new org.apache.thrift.meta_data.FieldMetaData("type", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, PCompactionType.class)));
    tmpMap.put(_Fields.REASON, new org.apache.thrift.meta_data.FieldMetaData("reason", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, PCompactionReason.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PActiveCompaction.class, metaDataMap);
  }

  public PActiveCompaction() {
  }
  ...
  public PActiveCompaction(
    ...
    String outputFile,
    PCompactionType type,
    PCompactionReason reason,
   ...
   */
  public PActiveCompaction(PActiveCompaction other) {
  ...
  public PActiveCompaction deepCopy() {
    return new PActiveCompaction(this);
  }
  ...
  public PActiveCompaction setExtent(PKeyExtent extent) {
    this.extent = extent;
    return this;
  }
  ...
  public PActiveCompaction setAge(long age) {
    this.age = age;
    setAgeIsSet(true);
    return this;
  }
  ...
  public PActiveCompaction setInputFiles(List<String> inputFiles) {
    this.inputFiles = inputFiles;
    return this;
  }
  ...
  public PActiveCompaction setOutputFile(String outputFile) {
    this.outputFile = outputFile;
    return this;
  }
   ...
   * @see PCompactionType
   */
  public PCompactionType getType() {
    return this.type;
  }
   ...
   * @see PCompactionType
   */
  public PActiveCompaction setType(PCompactionType type) {
    this.type = type;
    return this;
  }
   ...
   * @see PCompactionReason
   */
  public PCompactionReason getReason() {
    return this.reason;
  }
   ...
   * @see PCompactionReason
   */
  public PActiveCompaction setReason(PCompactionReason reason) {
    this.reason = reason;
    return this;
  }
  ...
  public PActiveCompaction setLocalityGroup(String localityGroup) {
    this.localityGroup = localityGroup;
    return this;
  }
  ...
  public PActiveCompaction setEntriesRead(long entriesRead) {
    this.entriesRead = entriesRead;
    setEntriesReadIsSet(true);
    return this;
  }
  ...
  public PActiveCompaction setEntriesWritten(long entriesWritten) {
    this.entriesWritten = entriesWritten;
    setEntriesWrittenIsSet(true);
    return this;
  }
  ...
  public PActiveCompaction setIterators(List<PIteratorSetting> iterators) {
    this.iterators = iterators;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case REASON:
      if (value == null) {
        ...
        setReason((PCompactionReason)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PActiveCompaction)
      return this.equals((PActiveCompaction)that);
    return false;
  }

  public boolean equals(PActiveCompaction that) {
    if (that == null)
      return false;
  ...
  public int compareTo(PActiveCompaction other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    PActiveCompaction typedOther = (PActiveCompaction)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PActiveCompaction(");
    boolean first = true;
  ...
  private static class PActiveCompactionStandardSchemeFactory implements SchemeFactory {
    public PActiveCompactionStandardScheme getScheme() {
      return new PActiveCompactionStandardScheme();
    }
  }

  private static class PActiveCompactionStandardScheme extends StandardScheme<PActiveCompaction> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PActiveCompaction struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 5: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = PCompactionType.findByValue(iprot.readI32());
          ...
          case 6: // REASON
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.reason = PCompactionReason.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.iterators = new ArrayList<PIteratorSetting>(_list45.size);
                for (int _i46 = 0; _i46 < _list45.size; ++_i46)
                {
                  PIteratorSetting _elem47; // required
                  _elem47 = new PIteratorSetting();
                  _elem47.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PActiveCompaction struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.iterators != null) {
        oprot.writeFieldBegin(ITERATORS_FIELD_DESC);
        {
          ...
          for (PIteratorSetting _iter49 : struct.iterators)
          {
            _iter49.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class PActiveCompactionTupleSchemeFactory implements SchemeFactory {
    public PActiveCompactionTupleScheme getScheme() {
      return new PActiveCompactionTupleScheme();
    }
  }

  private static class PActiveCompactionTupleScheme extends TupleScheme<PActiveCompaction> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PActiveCompaction struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetIterators()) {
        {
          ...
          for (PIteratorSetting _iter51 : struct.iterators)
          {
            _iter51.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PActiveCompaction struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.iterators = new ArrayList<PIteratorSetting>(_list55.size);
          for (int _i56 = 0; _i56 < _list55.size; ++_i56)
          {
            PIteratorSetting _elem57; // required
            _elem57 = new PIteratorSetting();
            _elem57.read(iprot);
