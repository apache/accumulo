...
public class MultiAuthVisibilityFilterTest {
  ...
  private void verify(TreeMap<Key,Value> source, int expectedSourceSize, Map<String,String> options,
    ...
    Filter filter = new MultiAuthVisibilityFilter();
  ...
  public void testAllowValidLabelsOnly() throws IOException {
    IteratorSetting is = new IteratorSetting(1, MultiAuthVisibilityFilter.class);
    MultiAuthVisibilityFilter.filterInvalidLabelsOnly(is, true);
  ...
  public void testAllowBadLabelsOnly() throws IOException {
    IteratorSetting is = new IteratorSetting(1, MultiAuthVisibilityFilter.class);
    MultiAuthVisibilityFilter.setNegate(is, true);
    MultiAuthVisibilityFilter.filterInvalidLabelsOnly(is, true);
  ...
  public void testAllowAuthorizedLabelsOnly() throws IOException {
    IteratorSetting is = new IteratorSetting(1, MultiAuthVisibilityFilter.class);
    MultiAuthVisibilityFilter.setAuthorizations(is, Set.of(new Authorizations("def")));
  ...
  public void testNoLabels() throws IOException {
    IteratorSetting is = new IteratorSetting(1, MultiAuthVisibilityFilter.class);
    MultiAuthVisibilityFilter.setNegate(is, false);
    MultiAuthVisibilityFilter.setAuthorizations(is, Set.of(new Authorizations()));
  ...
  public void testStaticConfigurators() {
    IteratorSetting is = new IteratorSetting(1, MultiAuthVisibilityFilter.class);
    MultiAuthVisibilityFilter.filterInvalidLabelsOnly(is, false);
    MultiAuthVisibilityFilter.setNegate(is, true);
    MultiAuthVisibilityFilter.setAuthorizations(is, Set.of(new Authorizations("abc", "def")));

    Map<String,String> opts = is.getOptions();
    assertEquals("false", opts.get("filterInvalid"));
    assertEquals("true", opts.get("negate"));
    assertEquals("1", opts.get("numAuths"));
  ...
  public void testDeepCopyAfterInit() throws IOException {
    IteratorSetting is = new IteratorSetting(1, MultiAuthVisibilityFilter.class);
    MultiAuthVisibilityFilter.setAuthorizations(is, Set.of(new Authorizations("abc")));
    Map<String,String> opts = is.getOptions();
    Filter filter = new MultiAuthVisibilityFilter();
    TreeMap<Key,Value> source = new TreeMap<>();
