...
public class MeterRegistryFactoryTest {
   ...
   * {@link MeterRegistryFactory#getMeterFilter(String)}, that we catch a NullPointerException and
   ...
   * {@link MeterRegistryFactory#getMeterFilter(String)}, that we catch an IllegalArgumentException
   ...
   * {@link MeterRegistryFactory#getMeterFilter(String)}, that a PatternSyntaxException is thrown.
   */
  @Test
  public void testIfPatternListInvalid() {
    assertThrows(PatternSyntaxException.class, () -> MeterRegistryFactory.getMeterFilter("[\\]"),
   ...
   * {@link MeterRegistryFactory#getMeterFilter(String)} and the resulting filter is given an id
