...
class ClientConfigGenerate {
  ...
  private class Markdown extends Format {
    ...
    void pageHeader() {
      ...
      doc.println("Below are properties set in `accumulo-client.properties` that configure [Accumulo clients]({{ page.docs_baseurl }}/getting-started/clients#connecting). All properties have been part of the API since 2.0.0 (unless otherwise specified):\n");
