...
/**
 * An AES Encryption implementation for table encryption. This implementation uses the Java Cipher
 * class from the Java Cryptographic Extension (JCE) framework. The transform used for encryption
 * and decryption is AES/GCM/NoPadding with a key size of 128. For more information see
 * {@link Cipher}.
 */
public class AESTableCryptoService implements CryptoService {
  ...
  private static byte[] createCryptoParameters(String version, Key encryptingKek,
    ...
    try (ByteArrayOutputStream baos = new ByteArrayOutputStream();
      ...
      params.writeUTF(AESTableCryptoService.class.getName());
