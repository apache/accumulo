...
public class DecompressorPoolFactory implements KeyedPooledObjectFactory<Algorithm,Decompressor> {
  ...
  @Override
  public void destroyObject(Algorithm algorithm, PooledObject<Decompressor> pooledObject)
      throws Exception {
  ...
  @Override
  public void activateObject(Algorithm algorithm, PooledObject<Decompressor> pooledObject)
      throws Exception {
    pooledObject.getObject().reset();
  }

  @Override
  public void passivateObject(Algorithm algorithm, PooledObject<Decompressor> pooledObject)
      throws Exception {
    pooledObject.getObject().reset();
  }
