 ...
 *
 * @since 2.1.0 Replaces class in org.apache.accumulo.core.constraints package
 */
public class Violations {

  protected static class CVSKey {
    private final String className;
    private final short vcode;
  ...
  protected Violations(Map<CVSKey,ConstraintViolationSummary> cvsmap) {
    this.cvsmap = cvsmap;
  }
