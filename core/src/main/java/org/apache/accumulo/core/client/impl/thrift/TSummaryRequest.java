            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.summarizers = new java.util.ArrayList<TSummarizerConfiguration>(_list36.size);
                TSummarizerConfiguration _elem37;
                for (int _i38 = 0; _i38 < _list36.size; ++_i38)
                {
                  _elem37 = new TSummarizerConfiguration();
                  _elem37.read(iprot);
                  struct.summarizers.add(_elem37);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSummaryRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.summarizers != null) {
        oprot.writeFieldBegin(SUMMARIZERS_FIELD_DESC);
        {
          ...
          for (TSummarizerConfiguration _iter39 : struct.summarizers)
          {
            _iter39.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetSummarizers()) {
        {
          ...
          for (TSummarizerConfiguration _iter40 : struct.summarizers)
          {
            _iter40.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.summarizers = new java.util.ArrayList<TSummarizerConfiguration>(_list41.size);
          TSummarizerConfiguration _elem42;
          for (int _i43 = 0; _i43 < _list41.size; ++_i43)
          {
            _elem42 = new TSummarizerConfiguration();
            _elem42.read(iprot);
            struct.summarizers.add(_elem42);
          }
        }
        struct.setSummarizersIsSet(true);
      }
