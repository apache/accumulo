...
import org.apache.accumulo.core.manager.thrift.FateService.Client.Factory;
import org.apache.accumulo.core.rpc.clients.ThriftClientTypes.ThriftClientType;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class FateThriftClient extends ThriftClientType<Client,Factory>
    implements ManagerClient<Client> {

  private static Logger LOG = LoggerFactory.getLogger(FateThriftClient.class);

  FateThriftClient(String serviceName, Factory clientFactory) {
