            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.options = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map8.size);
                ...
                for (int _i11 = 0; _i11 < _map8.size; ++_i11)
                {
                  ...
                  struct.options.put(_key9, _val10);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSummarizerConfiguration struct) throws org.apache.thrift.TException {
      ...
      if (struct.options != null) {
        oprot.writeFieldBegin(OPTIONS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter12 : struct.options.entrySet())
          {
      ...
      if (struct.isSetOptions()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter13 : struct.options.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.options = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map14.size);
          ...
          for (int _i17 = 0; _i17 < _map14.size; ++_i17)
          {
            ...
            struct.options.put(_key15, _val16);
          }
        }
        struct.setOptionsIsSet(true);
      }
