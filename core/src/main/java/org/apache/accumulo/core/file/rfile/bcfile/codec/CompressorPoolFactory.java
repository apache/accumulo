...
public class CompressorPoolFactory implements KeyedPooledObjectFactory<Algorithm,Compressor> {
  ...
  @Override
  public void destroyObject(Algorithm algorithm, PooledObject<Compressor> pooledObject)
      throws Exception {
  ...
  @Override
  public void activateObject(Algorithm algorithm, PooledObject<Compressor> pooledObject)
      throws Exception {
    pooledObject.getObject().reset();
  }

  @Override
  public void passivateObject(Algorithm algorithm, PooledObject<Compressor> pooledObject)
      throws Exception {
