...
class ConditionalWriterImpl implements ConditionalWriter {
   ...
   * status is unknown and not have to worry about the tserver applying the mutation after the scan. If a conditional mutation is taking a long time to process,
   * then this method will wait for it to finish... unless this exceeds timeout.
   */
