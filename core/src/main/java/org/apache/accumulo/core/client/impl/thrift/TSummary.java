            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.summary = new java.util.HashMap<java.lang.String,java.lang.Long>(2*_map18.size);
                ...
                for (int _i21 = 0; _i21 < _map18.size; ++_i21)
                {
                  ...
                  struct.summary.put(_key19, _val20);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSummary struct) throws org.apache.thrift.TException {
      ...
      if (struct.summary != null) {
        oprot.writeFieldBegin(SUMMARY_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Long> _iter22 : struct.summary.entrySet())
          {
      ...
      if (struct.isSetSummary()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Long> _iter23 : struct.summary.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.summary = new java.util.HashMap<java.lang.String,java.lang.Long>(2*_map24.size);
          ...
          for (int _i27 = 0; _i27 < _map24.size; ++_i27)
          {
            ...
            struct.summary.put(_key25, _val26);
          }
        }
        struct.setSummaryIsSet(true);
      }
