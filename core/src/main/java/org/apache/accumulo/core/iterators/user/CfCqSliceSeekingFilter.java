...
public class ColumnSliceSeekingFilter extends SeekingFilter implements OptionDescriber {
    ...
    public SortedKeyValueIterator<Key, Value> deepCopy(IteratorEnvironment env) {
        ColumnSliceSeekingFilter o = (ColumnSliceSeekingFilter)super.deepCopy(env);
