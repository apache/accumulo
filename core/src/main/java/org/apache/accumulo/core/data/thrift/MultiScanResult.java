...
public class MultiScanResult implements org.apache.thrift.TBase<MultiScanResult, MultiScanResult._Fields>, java.io.Serializable, Cloneable, Comparable<MultiScanResult> {
  ...
  private static final int PARTNEXTKEYINCLUSIVE_ISSET_ID = 0;
  private static final int MORE_ISSET_ID = 1;
  private byte isset_bitfield = 0;
  ...
  public MultiScanResult(MultiScanResult other) {
    isset_bitfield = other.isset_bitfield;
    if (other.isSetResults()) {
      List<TKeyValue> thisResults = new ArrayList<TKeyValue>(other.results.size());
      for (TKeyValue other_element : other.results) {
        thisResults.add(new TKeyValue(other_element));
      }
    ...
    if (other.isSetFullScans()) {
      List<TKeyExtent> thisFullScans = new ArrayList<TKeyExtent>(other.fullScans.size());
      for (TKeyExtent other_element : other.fullScans) {
        thisFullScans.add(new TKeyExtent(other_element));
      }
      this.fullScans = thisFullScans;
    }
  ...
  public void unsetPartNextKeyInclusive() {
    isset_bitfield = EncodingUtils.clearBit(isset_bitfield, PARTNEXTKEYINCLUSIVE_ISSET_ID);
  }
  ...
  public boolean isSetPartNextKeyInclusive() {
    return EncodingUtils.testBit(isset_bitfield, PARTNEXTKEYINCLUSIVE_ISSET_ID);
  }

  public void setPartNextKeyInclusiveIsSet(boolean value) {
    isset_bitfield = EncodingUtils.setBit(isset_bitfield, PARTNEXTKEYINCLUSIVE_ISSET_ID, value);
  }
  ...
  public void unsetMore() {
    isset_bitfield = EncodingUtils.clearBit(isset_bitfield, MORE_ISSET_ID);
  }

  /** Returns true if field more is set (has been assigned a value) and false otherwise */
  public boolean isSetMore() {
    return EncodingUtils.testBit(isset_bitfield, MORE_ISSET_ID);
  }

  public void setMoreIsSet(boolean value) {
    isset_bitfield = EncodingUtils.setBit(isset_bitfield, MORE_ISSET_ID, value);
  }
