...
public class MultiAuthVisibilityFilter extends Filter implements OptionDescriber {
  ...
  public SortedKeyValueIterator<Key,Value> deepCopy(IteratorEnvironment env) {
    MultiAuthVisibilityFilter result = (MultiAuthVisibilityFilter) super.deepCopy(env);
  ...
  public IteratorOptions describeOptions() {
    ...
    io.setName("multiAuthVisibilityFilter");
    io.setDescription("The MultiAuthVisibilityFilter allows you to filter for key/value"
        + " pairs by a collection of sets of authorizations or filter invalid labels from corrupt files.");
