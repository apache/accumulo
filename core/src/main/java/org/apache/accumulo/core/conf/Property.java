...
public enum Property {
  COMPACTION_PREFIX("compaction.", null, PropertyType.PREFIX, false,
      "Both major and minor compaction properties can be included under this prefix.", "4.0.0"),
  COMPACTION_SERVICE_PREFIX(COMPACTION_PREFIX + "service.", null, PropertyType.PREFIX, false,
      """
  ...
  COMPACTION_SERVICE_DEFAULT_PLANNER(
      ...
      RatioBasedCompactionPlanner.class.getName(), PropertyType.CLASSNAME, false,
  ...
  COMPACTION_SERVICE_DEFAULT_MAX_OPEN(COMPACTION_SERVICE_DEFAULT_PLANNER + ".opts.maxOpen", "10",
      PropertyType.COUNT, false, "The maximum number of files a compaction will open.", "4.0.0"),
  COMPACTION_SERVICE_DEFAULT_GROUPS(COMPACTION_SERVICE_DEFAULT_PLANNER + ".opts.groups", """
      [{"group": "default"}]""", PropertyType.JSON, false,
      "See {% jlink -f org.apache.accumulo.core.spi.compaction.RatioBasedCompactionPlanner %}.",
      "4.0.0"),
  COMPACTION_WARN_TIME(COMPACTION_PREFIX + "warn.time", "10m", PropertyType.TIMEDURATION, false,
  ...
  RPC_PREFIX("rpc.", null, PropertyType.PREFIX, false,
      "Properties in this category related to the configuration of SSL keys for"
          + " RPC. See also `instance.ssl.enabled`.",
      "1.6.0"),
  RPC_PROCESS_ADVERTISE_ADDRESS("rpc.advertise.addr", "", PropertyType.STRING, false, """
      ...
      """, "2.1.4"),
  RPC_PROCESS_BIND_ADDRESS("rpc.bind.addr", "", PropertyType.STRING, false, """
  ...
  RPC_MAX_MESSAGE_SIZE("rpc.message.size.max", Integer.toString(Integer.MAX_VALUE),
      PropertyType.BYTES, false, "The maximum size of a message that can be received by a server.",
      "2.1.3"),
  RPC_BACKLOG("rpc.backlog", "50", PropertyType.COUNT, false, """
      ...
      """, "2.1.3"),
  RPC_SSL_KEYSTORE_PATH("rpc.javax.net.ssl.keyStore", "", PropertyType.PATH, false,
      "Path of the keystore file for the server's private SSL key.", "1.6.0"),
  @Sensitive
  RPC_SSL_KEYSTORE_PASSWORD("rpc.javax.net.ssl.keyStorePassword", "", PropertyType.STRING, false,
      "Password used to encrypt the SSL private keystore. "
          + "Leave blank to use the Accumulo instance secret.",
      "1.6.0"),
  RPC_SSL_KEYSTORE_TYPE("rpc.javax.net.ssl.keyStoreType", "jks", PropertyType.STRING, false,
      "Type of SSL keystore.", "1.6.0"),
  RPC_SSL_TRUSTSTORE_PATH("rpc.javax.net.ssl.trustStore", "", PropertyType.PATH, false,
  ...
  RPC_SSL_TRUSTSTORE_PASSWORD("rpc.javax.net.ssl.trustStorePassword", "", PropertyType.STRING,
      false, "Password used to encrypt the SSL truststore. Leave blank to use no password.",
      "1.6.0"),
  RPC_SSL_TRUSTSTORE_TYPE("rpc.javax.net.ssl.trustStoreType", "jks", PropertyType.STRING, false,
      "Type of SSL truststore.", "1.6.0"),
  RPC_USE_JSSE("rpc.useJsse", "false", PropertyType.BOOLEAN, false,
      """
      ...
      "1.6.0"),
  RPC_SSL_CIPHER_SUITES("rpc.ssl.cipher.suites", "", PropertyType.STRING, false,
  ...
  RPC_SSL_ENABLED_PROTOCOLS("rpc.ssl.server.enabled.protocols", "TLSv1.3", PropertyType.STRING,
      false, "Comma separated list of protocols that can be used to accept connections.", "1.6.2"),
  RPC_SSL_CLIENT_PROTOCOL("rpc.ssl.client.protocol", "TLSv1.3", PropertyType.STRING, false, """
      ...
      """, "1.6.2"),
  RPC_SASL_QOP("rpc.sasl.qop", "auth", PropertyType.STRING, false,
      "The quality of protection to be used with SASL. Valid values are 'auth', 'auth-int',"
          + " and 'auth-conf'.",
      "1.7.0"),

  // instance properties (must be the same for every node in an instance)
  INSTANCE_PREFIX("instance.", null, PropertyType.PREFIX, false,
      ...
      "1.3.5"),
  INSTANCE_ZK_HOST("instance.zookeeper.host", "localhost:2181", PropertyType.HOSTLIST, true,
      "Comma separated list of zookeeper servers.", "1.3.5"),
  INSTANCE_ZK_TIMEOUT("instance.zookeeper.timeout", "30s", PropertyType.TIMEDURATION, true,
      "Zookeeper session timeout; "
          + "max value when represented as milliseconds should be no larger than "
          + Integer.MAX_VALUE + ".",
      "1.3.5"),
  @Sensitive
  INSTANCE_SECRET("instance.secret", "DEFAULT", PropertyType.STRING, true, """
      ...
      admin changeSecret`.
      """, "1.3.5"),
  INSTANCE_VOLUMES("instance.volumes", "", PropertyType.VOLUMES, true, """
      ...
      """, "1.6.0"),
  INSTANCE_VOLUME_CONFIG_PREFIX("instance.volume.config.", null, PropertyType.PREFIX, false,
      """
          ...
          """,
      "2.1.1"),
  INSTANCE_VOLUMES_REPLACEMENTS("instance.volumes.replacements", "", PropertyType.STRING, false, """
  ...
  INSTANCE_SECURITY_AUTHENTICATOR("instance.security.authenticator",
      "org.apache.accumulo.server.security.handler.ZKAuthenticator", PropertyType.CLASSNAME, false,
  ...
  INSTANCE_SECURITY_AUTHORIZOR("instance.security.authorizor",
      "org.apache.accumulo.server.security.handler.ZKAuthorizor", PropertyType.CLASSNAME, false,
  ...
  INSTANCE_SECURITY_PERMISSION_HANDLER("instance.security.permissionHandler",
      "org.apache.accumulo.server.security.handler.ZKPermHandler", PropertyType.CLASSNAME, false,
      "The permission handler class that accumulo will use to determine if a "
          + "user has privilege to perform an action.",
      "1.5.0"),
  INSTANCE_RPC_SSL_ENABLED("instance.rpc.ssl.enabled", "false", PropertyType.BOOLEAN, false,
      "Use SSL for socket connections from clients and among accumulo services. "
          + "Mutually exclusive with SASL RPC configuration.",
      "1.6.0"),
  INSTANCE_RPC_SSL_CLIENT_AUTH("instance.rpc.ssl.clientAuth", "false", PropertyType.BOOLEAN, false,
      "Require clients to present certs signed by a trusted root.", "1.6.0"),
  INSTANCE_RPC_SASL_ENABLED("instance.rpc.sasl.enabled", "false", PropertyType.BOOLEAN, false,
  ...
  @Experimental
  INSTANCE_CRYPTO_PREFIX("instance.crypto.opts.", null, PropertyType.PREFIX, false,
  ...
  INSTANCE_CRYPTO_SENSITIVE_PREFIX("instance.crypto.opts.sensitive.", null, PropertyType.PREFIX,
      false, "Sensitive properties related to on-disk file encryption.", "2.0.0"),
  @Experimental
  INSTANCE_CRYPTO_FACTORY("instance.crypto.opts.factory",
      "org.apache.accumulo.core.spi.crypto.NoCryptoServiceFactory", PropertyType.CLASSNAME, false,
      ...
      "2.1.0"),
  // general properties
  GENERAL_PREFIX("general.", null, PropertyType.PREFIX, false,
  ...
  GENERAL_RPC_TIMEOUT("general.rpc.timeout", "120s", PropertyType.TIMEDURATION, false,
      "Time to wait on I/O for simple, short RPC calls.", "1.3.5"),
  @Experimental
  GENERAL_RPC_SERVER_TYPE("general.rpc.server.type", "", PropertyType.STRING, false,
      ...
      "1.7.0"),
  GENERAL_KERBEROS_KEYTAB("general.kerberos.keytab", "", PropertyType.PATH, false,
      "Path to the kerberos keytab to use. Leave blank if not using kerberoized hdfs.", "1.4.1"),
  GENERAL_KERBEROS_PRINCIPAL("general.kerberos.principal", "", PropertyType.STRING, false,
  ...
  GENERAL_KERBEROS_RENEWAL_PERIOD("general.kerberos.renewal.period", "30s",
      PropertyType.TIMEDURATION, false,
  ...
  GENERAL_OPENTELEMETRY_ENABLED("general.opentelemetry.enabled", "false", PropertyType.BOOLEAN,
      ...
      "2.1.0"),
  GENERAL_THREADPOOL_SIZE("general.server.threadpool.size", "3", PropertyType.COUNT, true,
  ...
  GENERAL_SECURITY_CREDENTIAL_PROVIDER_PATHS("general.security.credential.provider.paths", "",
      PropertyType.STRING, false, "Comma-separated list of paths to CredentialProviders.", "1.6.1"),
  GENERAL_ARBITRARY_PROP_PREFIX("general.custom.", null, PropertyType.PREFIX, false,
  ...
  GENERAL_CACHE_MANAGER_IMPL("general.block.cache.manager.class",
      TinyLfuBlockCacheManager.class.getName(), PropertyType.STRING, false,
  ...
  GENERAL_DELEGATION_TOKEN_LIFETIME("general.delegation.token.lifetime", "7d",
      PropertyType.TIMEDURATION, true,
  ...
  GENERAL_DELEGATION_TOKEN_UPDATE_INTERVAL("general.delegation.token.update.interval", "1d",
      PropertyType.TIMEDURATION, true, "The length of time between generation of new secret keys.",
      "1.7.0"),
  ...
  GENERAL_LOW_MEM_DETECTOR_INTERVAL("general.low.mem.detector.interval", "5s",
      PropertyType.TIMEDURATION, true, "The time interval between low memory checks.", "3.0.0"),
  GENERAL_LOW_MEM_DETECTOR_THRESHOLD("general.low.mem.detector.threshold", "0.05",
      PropertyType.FRACTION, true,
  ...
  GENERAL_MICROMETER_CACHE_METRICS_ENABLED("general.micrometer.cache.metrics.enabled", "false",
      ...
      "4.0.0"),
  GENERAL_MICROMETER_ENABLED("general.micrometer.enabled", "true", PropertyType.BOOLEAN, false,
  ...
  GENERAL_MICROMETER_FACTORY("general.micrometer.factory",
      ...
      PropertyType.CLASSNAMELIST, false,
      """
          ...
          """,
      "2.1.0"),
  GENERAL_MICROMETER_USER_TAGS("general.micrometer.user.tags", "", PropertyType.STRING, false, """
  ...
  GENERAL_PROCESS_BIND_ADDRESS("general.process.bind.addr", "0.0.0.0", PropertyType.STRING, false,
  ...
  GENERAL_SERVER_ITERATOR_OPTIONS_COMPRESSION_ALGO("general.server.iter.opts.compression", "none",
      PropertyType.COMPRESSION_TYPE, false,
  ...
  GENERAL_SERVER_WAL_SORT_BUFFER_SIZE("general.server.wal.sort.buffer.size", "10%",
      PropertyType.MEMORY, false, "The amount of memory to use when sorting logs during recovery.",
      "4.0.0"),

  // properties that are specific to manager server behavior
  MANAGER_PREFIX("manager.", null, PropertyType.PREFIX, false,
      "Properties in this category affect the behavior of the manager server.", "2.1.0"),
  MANAGER_CLIENTPORT("manager.port.client", "9999-10009", PropertyType.PORT, true,
      "The port used for handling client connections on the manager.", "1.3.5"),
  MANAGER_TABLET_BALANCER("manager.tablet.balancer",
      "org.apache.accumulo.core.spi.balancer.TableLoadBalancer", PropertyType.CLASSNAME, false,
  ...
  MANAGER_TABLE_DELETE_OPTIMIZATION("manager.table.delete.optimization", "true",
      ...
      "2.1.5"),
  MANAGER_BULK_TIMEOUT("manager.bulk.timeout", "5m", PropertyType.TIMEDURATION, false,
      "The time to wait for a tablet server to process a bulk import request.", "1.4.3"),
  MANAGER_RENAME_THREADS("manager.rename.threadpool.size", "20", PropertyType.COUNT, false,
      "The number of threads to use when renaming user files during table import or bulk ingest.",
      "2.1.0"),
  MANAGER_MINTHREADS("manager.server.threads.minimum", "20", PropertyType.COUNT, false,
  ...
  MANAGER_MINTHREADS_TIMEOUT("manager.server.threads.timeout", "0s", PropertyType.TIMEDURATION,
      ...
      "2.1.0"),
  MANAGER_THREADCHECK("manager.server.threadcheck.time", "1s", PropertyType.TIMEDURATION, false,
      "The time between adjustments of the server thread pool.", "1.4.0"),
  MANAGER_RECOVERY_DELAY("manager.recovery.delay", "10s", PropertyType.TIMEDURATION, false,
  ...
  MANAGER_WAL_CLOSER_IMPLEMENTATION("manager.wal.closer.implementation",
      "org.apache.accumulo.server.manager.recovery.HadoopLogCloser", PropertyType.CLASSNAME, false,
  ...
  MANAGER_FATE_METRICS_MIN_UPDATE_INTERVAL("manager.fate.metrics.min.update.interval", "60s",
      PropertyType.TIMEDURATION, false,
      "Limit calls from metric sinks to zookeeper to update interval.", "1.9.3"),
  MANAGER_FATE_USER_CONFIG("manager.fate.user.config",
      ...
      PropertyType.FATE_USER_CONFIG, false, """
  ...
  MANAGER_FATE_META_CONFIG("manager.fate.meta.config",
      ...
      PropertyType.FATE_META_CONFIG, false, """
  ...
  MANAGER_FATE_THREADPOOL_SIZE("manager.fate.threadpool.size", "",
      PropertyType.FATE_THREADPOOL_SIZE, false, """
  ...
  MANAGER_FATE_IDLE_CHECK_INTERVAL("manager.fate.idle.check.interval", "60m",
      PropertyType.TIMEDURATION, false, """
          ...
          """.formatted(MANAGER_FATE_USER_CONFIG.getKey(), MANAGER_FATE_META_CONFIG.getKey()),
      "4.0.0"),
  MANAGER_STATUS_THREAD_POOL_SIZE("manager.status.threadpool.size", "0", PropertyType.COUNT, false,
      ...
      "1.8.0"),
  MANAGER_METADATA_SUSPENDABLE("manager.metadata.suspendable", "false", PropertyType.BOOLEAN, false,
  ...
  MANAGER_COMPACTION_SERVICE_PRIORITY_QUEUE_SIZE("manager.compaction.major.service.queue.size",
      "1M", PropertyType.MEMORY, false, """
          ...
          needed.
          """, "4.0.0"),
  SPLIT_PREFIX("split.", null, PropertyType.PREFIX, false,
      "System wide properties related to splitting tablets.", "4.0.0"),
  SPLIT_MAXOPEN("split.files.max", "300", PropertyType.COUNT, false, """
  ...
  SSERV_PREFIX("sserver.", null, PropertyType.PREFIX, false,
      "Properties in this category affect the behavior of the scan servers.", "2.1.0"),
  SSERV_DATACACHE_SIZE("sserver.cache.data.size", "10%", PropertyType.MEMORY, false,
      "Specifies the size of the cache for RFile data blocks on each scan server.", "2.1.0"),
  SSERV_INDEXCACHE_SIZE("sserver.cache.index.size", "25%", PropertyType.MEMORY, false,
      "Specifies the size of the cache for RFile index blocks on each scan server.", "2.1.0"),
  SSERV_SUMMARYCACHE_SIZE("sserver.cache.summary.size", "10%", PropertyType.MEMORY, false,
      "Specifies the size of the cache for summary data on each scan server.", "2.1.0"),
  SSERV_DEFAULT_BLOCKSIZE("sserver.default.blocksize", "1M", PropertyType.BYTES, false,
  ...
  SSERV_CACHED_TABLET_METADATA_REFRESH_PERCENT("sserver.cache.metadata.refresh.percent", ".75",
      PropertyType.FRACTION, false, """
          ...
          """, "2.1.3"),
  SSERV_CLIENTPORT("sserver.port.client", "9700-9799", PropertyType.PORT, false,
      "The port used for handling client connections on the tablet servers.", "2.1.0"),
  SSERV_MINTHREADS("sserver.server.threads.minimum", "20", PropertyType.COUNT, false,
      "The minimum number of threads to use to handle incoming requests.", "2.1.0"),
  SSERV_MINTHREADS_TIMEOUT("sserver.server.threads.timeout", "0s", PropertyType.TIMEDURATION, false,
      "The time after which incoming request threads terminate with no work available.  Zero (0) will keep the threads alive indefinitely.",
      "2.1.0"),
  SSERV_SCAN_EXECUTORS_PREFIX("sserver.scan.executors.", null, PropertyType.PREFIX, false, """
  ...
  SSERV_SCAN_EXECUTORS_DEFAULT_THREADS("sserver.scan.executors.default.threads", "16",
      PropertyType.COUNT, false,
      "The number of threads for the scan executor that tables use by default.", "2.1.0"),
  ...
  SSERV_SCAN_EXECUTORS_META_THREADS("sserver.scan.executors.meta.threads", "8", PropertyType.COUNT,
      false, "The number of threads for the metadata table scan executor.", "2.1.0"),
  ...
  SSERV_SCAN_ALLOWED_TABLES_DEPRECATED("sserver.scan.allowed.tables.group.", null,
      PropertyType.PREFIX, false,
      "A regular expression that determines which tables are allowed to be scanned for"
          + " servers in the specified group. The property name should end with the scan server"
          + " group and the property value should take into account the table namespace and name."
          + " The default value disallows scans on tables in the accumulo namespace.",
      "2.1.5"),
  SSERV_THREADCHECK("sserver.server.threadcheck.time", "1s", PropertyType.TIMEDURATION, false,
      "The time between adjustments of the thrift server thread pool.", "2.1.0"),
  SSERV_WAL_SORT_MAX_CONCURRENT("sserver.wal.sort.concurrent.max", "2", PropertyType.COUNT, false,
      "The maximum number of threads to use to sort logs during recovery.", "4.0.0"),
  // properties that are specific to tablet server behavior
  TSERV_PREFIX("tserver.", null, PropertyType.PREFIX, false,
      "Properties in this category affect the behavior of the tablet servers.", "1.3.5"),
  TSERV_CLIENT_TIMEOUT("tserver.client.timeout", "3s", PropertyType.TIMEDURATION, false,
      "Time to wait for clients to continue scans before closing a session.", "1.3.5"),
  TSERV_DEFAULT_BLOCKSIZE("tserver.default.blocksize", "1M", PropertyType.BYTES, false,
      "Specifies a default blocksize for the tserver caches.", "1.3.5"),
  TSERV_DATACACHE_SIZE("tserver.cache.data.size", "10%", PropertyType.MEMORY, false,
      "Specifies the size of the cache for RFile data blocks.", "1.3.5"),
  TSERV_INDEXCACHE_SIZE("tserver.cache.index.size", "25%", PropertyType.MEMORY, false,
      "Specifies the size of the cache for RFile index blocks.", "1.3.5"),
  TSERV_SUMMARYCACHE_SIZE("tserver.cache.summary.size", "10%", PropertyType.MEMORY, false,
      "Specifies the size of the cache for summary data on each tablet server.", "2.0.0"),
  TSERV_CLIENTPORT("tserver.port.client", "9800-9899", PropertyType.PORT, true,
  ...
  TSERV_TOTAL_MUTATION_QUEUE_MAX("tserver.total.mutation.queue.max", "5%", PropertyType.MEMORY,
      false, "The amount of memory used to store write-ahead-log mutations before flushing them.",
      "1.7.0"),
  TSERV_WAL_MAX_REFERENCED("tserver.wal.max.referenced", "3", PropertyType.COUNT, false,
      ...
      "2.1.0"),
  TSERV_WAL_MAX_SIZE("tserver.wal.max.size", "1G", PropertyType.BYTES, false,
      "The maximum size for each write-ahead log. See comment for property"
          + " `tserver.memory.maps.max`.",
      "2.1.0"),
  TSERV_WAL_MAX_AGE("tserver.wal.max.age", "24h", PropertyType.TIMEDURATION, false,
  ...
  TSERV_WAL_TOLERATED_MAXIMUM_WAIT_DURATION("tserver.wal.maximum.wait.duration", "5m",
      ...
      "2.1.0"),
  TSERV_SCAN_MAX_OPENFILES("tserver.scan.files.open.max", "100", PropertyType.COUNT, false,
      "Maximum total RFiles that all tablets in a tablet server can open for scans.", "1.4.0"),
  TSERV_MAX_IDLE("tserver.files.open.idle", "1m", PropertyType.TIMEDURATION, false,
      "Tablet servers leave previously used RFiles open for future queries."
          ...
          + " until it is closed.",
      "1.3.5"),
  TSERV_NATIVEMAP_ENABLED("tserver.memory.maps.native.enabled", "true", PropertyType.BOOLEAN, false,
      ...
      "1.3.5"),
  TSERV_MAXMEM("tserver.memory.maps.max", "33%", PropertyType.MEMORY, false, """
  ...
  TSERV_SESSION_MAXIDLE("tserver.session.idle.max", "1m", PropertyType.TIMEDURATION, false,
  ...
  TSERV_UPDATE_SESSION_MAXIDLE("tserver.session.update.idle.max", "1m", PropertyType.TIMEDURATION,
      ...
      "1.6.5"),
  TSERV_SCAN_EXECUTORS_PREFIX("tserver.scan.executors.", null, PropertyType.PREFIX, false, """
      Prefix for defining executors to service scans. See \
      [scan executors]({% durl administration/scan-executors %}) for an overview of why and \
      how to use this property. For each executor the number of threads, thread priority, \
      and an optional prioritizer can be configured. To configure a new executor, set \
  ...
  TSERV_SCAN_EXECUTORS_DEFAULT_THREADS("tserver.scan.executors.default.threads", "16",
      PropertyType.COUNT, false,
      "The number of threads for the scan executor that tables use by default.", "2.0.0"),
  ...
  TSERV_SCAN_EXECUTORS_META_THREADS("tserver.scan.executors.meta.threads", "8", PropertyType.COUNT,
      false, "The number of threads for the metadata table scan executor.", "2.0.0"),
  TSERV_SCAN_RESULTS_MAX_TIMEOUT("tserver.scan.results.max.timeout", "1s",
      ...
      "2.1.0"),
  TSERV_MIGRATE_MAXCONCURRENT("tserver.migrations.concurrent.max", "1", PropertyType.COUNT, false,
      "The maximum number of concurrent tablet migrations for a tablet server.", "1.3.5"),
  TSERV_MINC_MAXCONCURRENT("tserver.compaction.minor.concurrent.max", "4", PropertyType.COUNT,
      false, "The maximum number of concurrent minor compactions for a tablet server.", "1.3.5"),
  TSERV_BLOOM_LOAD_MAXCONCURRENT("tserver.bloom.load.concurrent.max", "4", PropertyType.COUNT,
      false,
      "The number of concurrent threads that will load bloom filters in the background. "
          + "Setting this to zero will make bloom filters load in the foreground.",
      "1.3.5"),
  TSERV_MEMDUMP_DIR("tserver.dir.memdump", "/tmp", PropertyType.PATH, false, """
      ...
      """, "1.3.5"),
  TSERV_MINTHREADS("tserver.server.threads.minimum", "20", PropertyType.COUNT, false,
      "The minimum number of threads to use to handle incoming requests.", "1.4.0"),
  TSERV_MINTHREADS_TIMEOUT("tserver.server.threads.timeout", "0s", PropertyType.TIMEDURATION, false,
      "The time after which incoming request threads terminate with no work available.  Zero (0) will keep the threads alive indefinitely.",
      "2.1.0"),
  TSERV_THREADCHECK("tserver.server.threadcheck.time", "1s", PropertyType.TIMEDURATION, false,
      "The time between adjustments of the server thread pool.", "1.4.0"),
  TSERV_LOG_BUSY_TABLETS_COUNT("tserver.log.busy.tablets.count", "0", PropertyType.COUNT, false,
  ...
  TSERV_LOG_BUSY_TABLETS_INTERVAL("tserver.log.busy.tablets.interval", "1h",
      PropertyType.TIMEDURATION, false,
      "Time interval between logging out busy tablets information.", "1.10.0"),
  TSERV_HOLD_TIME_SUICIDE("tserver.hold.time.max", "5m", PropertyType.TIMEDURATION, false, """
      ...
      """, "1.4.0"),
  TSERV_WAL_BLOCKSIZE("tserver.wal.blocksize", "0", PropertyType.BYTES, false,
      "The size of the HDFS blocks used to write to the Write-Ahead log. If"
          ...
          + " one block).",
      "1.5.0"),
  TSERV_WAL_REPLICATION("tserver.wal.replication", "0", PropertyType.COUNT, false,
      "The replication to use when writing the Write-Ahead log to HDFS. If"
          + " zero, it will use the HDFS default replication setting.",
      "1.5.0"),
  TSERV_WAL_SORT_MAX_CONCURRENT("tserver.wal.sort.concurrent.max", "2", PropertyType.COUNT, false,
  ...
  TSERV_WAL_SORT_BUFFER_SIZE("tserver.wal.sort.buffer.size", "10%", PropertyType.MEMORY, false,
      "The amount of memory to use when sorting logs during recovery.", "2.1.0"),
  TSERV_WAL_SORT_FILE_PREFIX("tserver.wal.sort.file.", null, PropertyType.PREFIX, false,
      ...
      "2.1.0"),
  TSERV_WAL_SYNC("tserver.wal.sync", "true", PropertyType.BOOLEAN, false,
  ...
  TSERV_ASSIGNMENT_MAXCONCURRENT("tserver.assignment.concurrent.max", "2", PropertyType.COUNT,
      ...
      "1.7.0"),
  TSERV_SLOW_FLUSH_MILLIS("tserver.slow.flush.time", "100ms", PropertyType.TIMEDURATION, false,
  ...
  TSERV_SUMMARY_PARTITION_THREADS("tserver.summary.partition.threads", "10", PropertyType.COUNT,
      false, """
          ...
          concurrently.
          """, "2.0.0"),
  TSERV_SUMMARY_REMOTE_THREADS("tserver.summary.remote.threads", "128", PropertyType.COUNT, false,
      """
  ...
  TSERV_CONDITIONAL_UPDATE_THREADS_ROOT("tserver.conditionalupdate.threads.root", "16",
      PropertyType.COUNT, false,
      "Numbers of threads for executing conditional updates on the root table.", "4.0.0"),
  ...
  TSERV_CONDITIONAL_UPDATE_THREADS_USER("tserver.conditionalupdate.threads.user", "64",
      PropertyType.COUNT, false,
      "Numbers of threads for executing conditional updates on user tables.", "4.0.0"),

  // accumulo garbage collector properties
  GC_PREFIX("gc.", null, PropertyType.PREFIX, false,
      "Properties in this category affect the behavior of the accumulo garbage collector.",
      "1.3.5"),
  GC_CANDIDATE_BATCH_SIZE("gc.candidate.batch.size", "50%", PropertyType.MEMORY, false,
      "The amount of memory used as the batch size for garbage collection.", "2.1.0"),
  GC_CYCLE_START("gc.cycle.start", "30s", PropertyType.TIMEDURATION, true,
      "Time to wait before attempting to garbage collect any old RFiles or write-ahead logs.",
      "1.3.5"),
  GC_CYCLE_DELAY("gc.cycle.delay", "5m", PropertyType.TIMEDURATION, true,
      "Time between garbage collection cycles. In each cycle, old RFiles or write-ahead logs "
          + "no longer in use are removed from the filesystem.",
      "1.3.5"),
  GC_PORT("gc.port.client", "9998", PropertyType.PORT, true,
      "The listening port for the garbage collector's monitor service.", "1.3.5"),
  GC_DELETE_WAL_THREADS("gc.threads.delete.wal", "4", PropertyType.COUNT, false,
      "The number of threads used to delete write-ahead logs and recovery files.", "2.1.4"),
  GC_DELETE_THREADS("gc.threads.delete", "16", PropertyType.COUNT, false,
      "The number of threads used to delete RFiles.", "1.3.5"),
  GC_SAFEMODE("gc.safemode", "false", PropertyType.BOOLEAN, false,
      "Provides listing of files to be deleted but does not delete any files.", "2.1.0"),
  GC_USE_FULL_COMPACTION("gc.post.metadata.action", "flush", PropertyType.GC_POST_ACTION, false, """
  ...
  MONITOR_PREFIX("monitor.", null, PropertyType.PREFIX, false,
      "Properties in this category affect the behavior of the monitor web server.", "1.3.5"),
  MONITOR_PORT("monitor.port.client", "9995", PropertyType.PORT, true,
      "The listening port for the monitor's http service.", "1.3.5"),
  MONITOR_SSL_KEYSTORE("monitor.ssl.keyStore", "", PropertyType.PATH, false,
      "The keystore for enabling monitor SSL.", "1.5.0"),
  @Sensitive
  MONITOR_SSL_KEYSTOREPASS("monitor.ssl.keyStorePassword", "", PropertyType.STRING, false,
      "The keystore password for enabling monitor SSL.", "1.5.0"),
  MONITOR_SSL_KEYSTORETYPE("monitor.ssl.keyStoreType", "jks", PropertyType.STRING, false,
      "Type of SSL keystore.", "1.7.0"),
  @Sensitive
  MONITOR_SSL_KEYPASS("monitor.ssl.keyPassword", "", PropertyType.STRING, false,
      "Optional: the password for the private key in the keyStore. When not provided, this "
          + "defaults to the keystore password.",
      "1.9.3"),
  MONITOR_SSL_TRUSTSTORE("monitor.ssl.trustStore", "", PropertyType.PATH, false,
      "The truststore for enabling monitor SSL.", "1.5.0"),
  @Sensitive
  MONITOR_SSL_TRUSTSTOREPASS("monitor.ssl.trustStorePassword", "", PropertyType.STRING, false,
      "The truststore password for enabling monitor SSL.", "1.5.0"),
  MONITOR_SSL_TRUSTSTORETYPE("monitor.ssl.trustStoreType", "jks", PropertyType.STRING, false,
      "Type of SSL truststore.", "1.7.0"),
  MONITOR_SSL_INCLUDE_CIPHERS("monitor.ssl.include.ciphers", "", PropertyType.STRING, false,
      "A comma-separated list of allows SSL Ciphers, see"
          + " monitor.ssl.exclude.ciphers to disallow ciphers.",
      "1.6.1"),
  MONITOR_SSL_EXCLUDE_CIPHERS("monitor.ssl.exclude.ciphers", "", PropertyType.STRING, false,
  ...
  MONITOR_SSL_INCLUDE_PROTOCOLS("monitor.ssl.include.protocols", "TLSv1.3", PropertyType.STRING,
      false, "A comma-separate list of allowed SSL protocols.", "1.5.3"),
  MONITOR_LOCK_CHECK_INTERVAL("monitor.lock.check.interval", "5s", PropertyType.TIMEDURATION, false,
      "The amount of time to sleep between checking for the Monitor ZooKeeper lock.", "1.5.1"),
  MONITOR_RESOURCES_EXTERNAL("monitor.resources.external", "", PropertyType.JSON, false, """
  ...
  MONITOR_PURGE_STATE_THRESHOLD("monitor.purge.state.threshold", "10m", PropertyType.TIMEDURATION,
      ...
      """
          ...
          """,
      "4.0.0"),
  MONITOR_FETCH_TIMEOUT("monitor.fetch.timeout", "5m", PropertyType.TIMEDURATION, false, """
  ...
  MONITOR_DEAD_LIST_RG_EXCLUSIONS("monitor.dead.server.rg.exclusions", "", PropertyType.STRING,
      false, """
          ...
          """, "4.0.0"),
  MONITOR_ROOT_CONTEXT("monitor.root.context", "/", PropertyType.STRING, false,
      """
  ...
  TABLE_PREFIX("table.", null, PropertyType.PREFIX, false, """
      ...
      """, "1.3.5"),
  TABLE_ARBITRARY_PROP_PREFIX("table.custom.", null, PropertyType.PREFIX, false,
  ...
  TABLE_COMPACTION_INPUT_DROP_CACHE_BEHIND("table.compaction.input.drop.cache", "ALL",
      PropertyType.DROP_CACHE_SELECTION, false, """
  ...
  TABLE_MAJC_OUTPUT_DROP_CACHE("table.compaction.major.output.drop.cache", "false",
      ...
      "2.1.1"),
  TABLE_MAJC_RATIO("table.compaction.major.ratio", "3", PropertyType.FRACTION, true,
      "Minimum ratio of total input size to maximum input RFile size for"
          + " running a major compaction.",
      "1.3.5"),
  TABLE_SPLIT_THRESHOLD("table.split.threshold", "1G", PropertyType.BYTES, true,
      "A tablet is split when the combined size of RFiles exceeds this amount.", "1.3.5"),
  TABLE_MAX_END_ROW_SIZE("table.split.endrow.size.max", "10k", PropertyType.BYTES, false,
      "Maximum size of end row.", "1.7.0"),
  TABLE_MINC_COMPACT_MAXAGE("table.compaction.minor.age", "10m", PropertyType.TIMEDURATION, false,
      """
  ...
  TABLE_COMPACTION_DISPATCHER("table.compaction.dispatcher",
      SimpleCompactionDispatcher.class.getName(), PropertyType.CLASSNAME, false,
  ...
  TABLE_COMPACTION_DISPATCHER_OPTS("table.compaction.dispatcher.opts.", null, PropertyType.PREFIX,
      false, "Options for the table compaction dispatcher.", "2.1.0"),
  TABLE_COMPACTION_SELECTION_EXPIRATION("table.compaction.selection.expiration.ms", "2m",
      ...
      """
          ...
          """,
      "2.1.0"),
  TABLE_COMPACTION_CONFIGURER("table.compaction.configurer", "", PropertyType.CLASSNAME, false,
  ...
  TABLE_COMPACTION_CONFIGURER_OPTS("table.compaction.configurer.opts.", null, PropertyType.PREFIX,
      false, "Options for the table compaction configuror.", "2.1.0"),
  ...
  // Crypto-related properties
  @Experimental
  TABLE_CRYPTO_PREFIX("table.crypto.opts.", null, PropertyType.PREFIX, false,
      "Properties related to on-disk file encryption.", "2.1.0"),
  @Experimental
  @Sensitive
  TABLE_CRYPTO_SENSITIVE_PREFIX("table.crypto.opts.sensitive.", null, PropertyType.PREFIX, false,
  ...
  TABLE_SCAN_DISPATCHER("table.scan.dispatcher", SimpleScanDispatcher.class.getName(),
      ...
      "2.0.0"),
  TABLE_SCAN_DISPATCHER_OPTS("table.scan.dispatcher.opts.", null, PropertyType.PREFIX, false,
      "Options for the table scan dispatcher.", "2.0.0"),
  TABLE_SCAN_MAXMEM("table.scan.max.memory", "512k", PropertyType.BYTES, false,
      "The maximum amount of memory that will be used to cache results of a client query/scan. "
          + "Once this limit is reached, the buffered data is sent to the client.",
      "1.3.5"),
  TABLE_BULK_MAX_TABLETS("table.bulk.max.tablets", "100", PropertyType.COUNT, false,
      "The maximum number of tablets allowed for one bulk import file. Value of 0 is Unlimited.",
      "2.1.0"),
  TABLE_BULK_MAX_TABLET_FILES("table.bulk.max.tablet.files", "100", PropertyType.COUNT, false,
      ...
      "4.0.0"),
  TABLE_SHUFFLE_SOURCES("table.shuffle.sources", "false", PropertyType.BOOLEAN, false,
      "Shuffle the opening order for Rfiles to reduce thread contention on file open operations.",
      "2.1.5"),
  TABLE_FILE_TYPE("table.file.type", RFile.EXTENSION, PropertyType.FILENAME_EXT, false,
  ...
  TABLE_LOAD_BALANCER("table.balancer", "org.apache.accumulo.core.spi.balancer.SimpleLoadBalancer",
      ...
      "1.3.5"),
  TABLE_FILE_COMPRESSION_TYPE("table.file.compress.type", "gz", PropertyType.STRING, false,
  ...
  TABLE_FILE_COMPRESSED_BLOCK_SIZE("table.file.compress.blocksize", "100k", PropertyType.BYTES,
      false, "The maximum size of data blocks in RFiles before they are compressed and written.",
      "1.3.5"),
  TABLE_FILE_COMPRESSED_BLOCK_SIZE_INDEX("table.file.compress.blocksize.index", "128k",
      ...
      "1.4.0"),
  TABLE_FILE_BLOCK_SIZE("table.file.blocksize", "0B", PropertyType.BYTES, false,
      ...
      "1.3.5"),
  TABLE_FILE_REPLICATION("table.file.replication", "0", PropertyType.COUNT, false,
      "The number of replicas for a table's RFiles in HDFS. When set to 0, HDFS"
          + " defaults are used.",
      "1.3.5"),
  TABLE_FILE_MAX("table.file.max", "15", PropertyType.COUNT, false, """
      ...
      """, "1.4.0"),
  TABLE_FILE_PAUSE("table.file.pause", "100", PropertyType.COUNT, false, """
  ...
  TABLE_MERGE_FILE_MAX("table.merge.file.max", "10000", PropertyType.COUNT, false, """
      ...
      """, "4.0.0"),
  TABLE_FILE_SUMMARY_MAX_SIZE("table.file.summary.maxSize", "256k", PropertyType.BYTES, false, """
      ...
      summary cache size.
      """, "2.0.0"),
  TABLE_BLOOM_ENABLED("table.bloom.enabled", "false", PropertyType.BOOLEAN, false,
      "Use bloom filters on this table.", "1.3.5"),
  TABLE_BLOOM_LOAD_THRESHOLD("table.bloom.load.threshold", "1", PropertyType.COUNT, false,
      ...
      "1.3.5"),
  TABLE_BLOOM_SIZE("table.bloom.size", "1048576", PropertyType.COUNT, false,
      "Bloom filter size, as number of keys.", "1.3.5"),
  TABLE_BLOOM_ERRORRATE("table.bloom.error.rate", "0.5%", PropertyType.FRACTION, false,
      "Bloom filter error rate.", "1.3.5"),
  TABLE_BLOOM_KEY_FUNCTOR("table.bloom.key.functor",
      "org.apache.accumulo.core.file.keyfunctor.RowFunctor", PropertyType.CLASSNAME, false, """
          ...
          """, "1.3.5"),
  TABLE_BLOOM_HASHTYPE("table.bloom.hash.type", "murmur", PropertyType.STRING, false,
      "The bloom filter hash type.", "1.3.5"),
  TABLE_BULK_SKIP_THRESHOLD("table.bulk.metadata.skip.distance", "0", PropertyType.COUNT, false,
      """
          ...
          """,
      "2.1.4"),
  TABLE_DURABILITY("table.durability", "sync", PropertyType.DURABILITY, false, """
  ...
  TABLE_FAILURES_IGNORE("table.failures.ignore", "false", PropertyType.BOOLEAN, false, """
  ...
  TABLE_DEFAULT_SCANTIME_VISIBILITY("table.security.scan.visibility.default", "",
      PropertyType.STRING, false, """
          ...
          """, "1.3.5"),
  TABLE_LOCALITY_GROUPS("table.groups.enabled", "", PropertyType.STRING, false,
      "A comma separated list of locality group names to enable for this table.", "1.3.5"),
  TABLE_CONSTRAINT_PREFIX("table.constraint.", null, PropertyType.PREFIX, false, """
      ...
      """, "1.3.5"),
  TABLE_INDEXCACHE_ENABLED("table.cache.index.enable", "true", PropertyType.BOOLEAN, false,
      "Determines whether index block cache is enabled for a table.", "1.3.5"),
  TABLE_BLOCKCACHE_ENABLED("table.cache.block.enable", "false", PropertyType.BOOLEAN, false,
      "Determines whether data block cache is enabled for a table.", "1.3.5"),
  TABLE_ITERATOR_PREFIX("table.iterator.", null, PropertyType.PREFIX, false, """
  ...
  TABLE_ITERATOR_MAJC_PREFIX(TABLE_ITERATOR_PREFIX.getKey() + IteratorScope.majc.name() + ".", null,
      ...
      "1.5.2"),
  TABLE_LOCALITY_GROUP_PREFIX("table.group.", null, PropertyType.PREFIX, false, """
  ...
  TABLE_FORMATTER_CLASS("table.formatter", DefaultFormatter.class.getName(), PropertyType.STRING,
      false, "The Formatter class to apply on results in the shell.", "1.4.0"),
  TABLE_CLASSLOADER_CONTEXT("table.class.loader.context", "", PropertyType.STRING, false,
      ...
      "2.1.0"),
  TABLE_SAMPLER("table.sampler", "", PropertyType.CLASSNAME, false, """
      ...
      sample data.
      """, "1.8.0"),
  TABLE_SAMPLER_OPTS("table.sampler.opt.", null, PropertyType.PREFIX, false,
      ...
      "1.8.0"),
  TABLE_SUSPEND_DURATION("table.suspend.duration", "0s", PropertyType.TIMEDURATION, false,
      ...
      "1.8.0"),
  TABLE_SUMMARIZER_PREFIX("table.summarizer.", null, PropertyType.PREFIX, false,
      """
  ...
  TABLE_DELETE_BEHAVIOR("table.delete.behavior",
      DeletingIterator.Behavior.PROCESS.name().toLowerCase(), PropertyType.STRING, false, """
  ...
  TABLE_ENABLE_ERASURE_CODES("table.file.ec", "inherit", PropertyType.EC, false, """
  ...
  TABLE_ERASURE_CODE_POLICY("table.file.ec.policy", "", PropertyType.STRING, false,
  ...
  COMPACTOR_PREFIX("compactor.", null, PropertyType.PREFIX, false,
  ...
  COMPACTOR_CANCEL_CHECK_INTERVAL("compactor.cancel.check.interval", "5m",
      ...
      "2.1.4"),
  COMPACTOR_CLIENTPORT("compactor.port.client", "9600-9699", PropertyType.PORT, false,
      "The port used for handling client connections on the compactor servers.", "2.1.0"),
  COMPACTOR_MIN_JOB_WAIT_TIME("compactor.wait.time.job.min", "1s", PropertyType.TIMEDURATION, false,
      ...
      "2.1.3"),
  COMPACTOR_MAX_JOB_WAIT_TIME("compactor.wait.time.job.max", "5m", PropertyType.TIMEDURATION, false,
  ...
  COMPACTOR_FAILURE_TERMINATION_THRESHOLD("compactor.failure.termination.threshold", "0",
      ...
      "2.1.4"),
  COMPACTOR_MINTHREADS("compactor.threads.minimum", "4", PropertyType.COUNT, false,
      "The minimum number of threads to use to handle incoming requests.", "2.1.0"),
  COMPACTOR_MINTHREADS_TIMEOUT("compactor.threads.timeout", "0s", PropertyType.TIMEDURATION, false,
      "The time after which incoming request threads terminate with no work available.  Zero (0) will keep the threads alive indefinitely.",
      "2.1.0"),
  COMPACTOR_THREADCHECK("compactor.threadcheck.time", "1s", PropertyType.TIMEDURATION, false,
  ...
  COMPACTOR_GROUP_NAME("compactor.group", Constants.DEFAULT_RESOURCE_GROUP_NAME,
      PropertyType.STRING, false, "Resource group name for this Compactor.", "3.0.0"),
  // CompactionCoordinator properties
  COMPACTION_COORDINATOR_PREFIX("compaction.coordinator.", null, PropertyType.PREFIX, false,
  ...
  COMPACTION_COORDINATOR_DEAD_COMPACTOR_CHECK_INTERVAL(
      ...
      false, "The interval at which to check for dead compactors.", "2.1.0"),
  ...
  Property(String name, String defaultValue, PropertyType type, boolean isRequired,
