...
public class UpdateErrors implements org.apache.thrift.TBase<UpdateErrors, UpdateErrors._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateErrors> {
  ...
  public java.util.Map<TKeyExtent,org.apache.accumulo.core.clientImpl.thrift.SecurityErrorCode> authorizationFailures; // required
  ...
  public UpdateErrors setAuthorizationFailures(java.util.Map<TKeyExtent,org.apache.accumulo.core.clientImpl.thrift.SecurityErrorCode> authorizationFailures) {
    this.authorizationFailures = authorizationFailures;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                TKeyExtent _key66;
                org.apache.accumulo.core.clientImpl.thrift.SecurityErrorCode _val67;
      ...
      if (incoming.get(2)) {
        {
          ...
          TKeyExtent _key83;
          org.apache.accumulo.core.clientImpl.thrift.SecurityErrorCode _val84;
