...
public interface MetricsProducer {
  ...
  String METRICS_BLOCKCACHE_HITCOUNT_PREFIX = METRICS_BLOCKCACHE_PREFIX + "hitcount.";
  String METRICS_BLOCKCACHE_REQUESTCOUNT_PREFIX = METRICS_BLOCKCACHE_PREFIX + "requestcount.";
  String METRICS_BLOCKCACHE_INDEX_HITCOUNT = METRICS_BLOCKCACHE_HITCOUNT_PREFIX + "index";
  String METRICS_BLOCKCACHE_INDEX_REQUESTCOUNT = METRICS_BLOCKCACHE_REQUESTCOUNT_PREFIX + "index";
  String METRICS_BLOCKCACHE_DATA_HITCOUNT = METRICS_BLOCKCACHE_HITCOUNT_PREFIX + "data";
  String METRICS_BLOCKCACHE_DATA_REQUESTCOUNT = METRICS_BLOCKCACHE_REQUESTCOUNT_PREFIX + "data";
  String METRICS_BLOCKCACHE_SUMMARY_HITCOUNT = METRICS_BLOCKCACHE_HITCOUNT_PREFIX + "summary";
  String METRICS_BLOCKCACHE_SUMMARY_REQUESTCOUNT =
      METRICS_BLOCKCACHE_REQUESTCOUNT_PREFIX + "summary";
