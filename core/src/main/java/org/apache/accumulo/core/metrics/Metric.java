...
public enum Metric {
  ...
  SCAN_START("accumulo.scan.start", MetricType.COUNTER,
      "Number of calls to start a scan or multiscan.", MetricCategory.SCAN_SERVER),
  SCAN_CONTINUE("accumulo.scan.continue", MetricType.COUNTER,
      "Number of calls to continue a scan or multiscan.", MetricCategory.SCAN_SERVER),
  SCAN_CLOSE("accumulo.scan.close", MetricType.COUNTER,
      "Number of calls to close a scan or multiscan.", MetricCategory.SCAN_SERVER),
  ...
  SCAN_PAUSED_FOR_MEM("accumulo.scan.paused.for.memory", MetricType.COUNTER,
      "Count of scans paused due to server being low on memory.", MetricCategory.SCAN_SERVER),
  ...
  UPDATE_COMMIT_PREP("accumulo.tserver.updates.commit.prep", MetricType.TIMER,
      "Time taken to prepare to commit a single mutation.", MetricCategory.TABLET_SERVER),
