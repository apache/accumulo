...
public class Retry {
  ...
  public void waitForNextAttempt(Logger log, String operationDesc) throws InterruptedException {
    ...
    log.debug("Sleeping for {}ms before retrying operation \"{}\"", currentWait, operationDesc);
