...
public class TDequeuedCompactionJob implements org.apache.thrift.TBase<TDequeuedCompactionJob, TDequeuedCompactionJob._Fields>, java.io.Serializable, Cloneable, Comparable<TDequeuedCompactionJob> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDequeuedCompactionJob");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDequeuedCompactionJobStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDequeuedCompactionJobTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDequeuedCompactionJob.class, metaDataMap);
  }

  public TDequeuedCompactionJob() {
  }
   ...
   */
  public TDequeuedCompactionJob(TDequeuedCompactionJob other) {
  ...
  @Override
  public TDequeuedCompactionJob deepCopy() {
    return new TDequeuedCompactionJob(this);
  }
  ...
  public TDequeuedCompactionJob setJob(@org.apache.thrift.annotation.Nullable TResolvedCompactionJob job) {
    this.job = job;
    return this;
  }
  ...
  public TDequeuedCompactionJob setCompactorCount(int compactorCount) {
    this.compactorCount = compactorCount;
    setCompactorCountIsSet(true);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof TDequeuedCompactionJob)
      return this.equals((TDequeuedCompactionJob)that);
    return false;
  }

  public boolean equals(TDequeuedCompactionJob that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDequeuedCompactionJob other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDequeuedCompactionJob(");
    boolean first = true;
  ...
  private static class TDequeuedCompactionJobStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public TDequeuedCompactionJobStandardScheme getScheme() {
      return new TDequeuedCompactionJobStandardScheme();
    }
  }

  private static class TDequeuedCompactionJobStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDequeuedCompactionJob> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, TDequeuedCompactionJob struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDequeuedCompactionJob struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TDequeuedCompactionJobTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public TDequeuedCompactionJobTupleScheme getScheme() {
      return new TDequeuedCompactionJobTupleScheme();
    }
  }

  private static class TDequeuedCompactionJobTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDequeuedCompactionJob> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDequeuedCompactionJob struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDequeuedCompactionJob struct) throws org.apache.thrift.TException {
