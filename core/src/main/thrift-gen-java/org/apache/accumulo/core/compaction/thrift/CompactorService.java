...
public class CompactorService {
  ...
  public interface Iface {
    ...
    public org.apache.accumulo.core.tabletserver.thrift.TExternalCompactionJob getRunningCompaction(org.apache.accumulo.core.securityImpl.thrift.TCredentials credentials) throws org.apache.accumulo.core.clientImpl.thrift.ThriftSecurityException, org.apache.thrift.TException;

    public java.lang.String getRunningCompactionId(org.apache.accumulo.core.securityImpl.thrift.TCredentials credentials) throws org.apache.accumulo.core.clientImpl.thrift.ThriftSecurityException, org.apache.thrift.TException;

    public java.util.List<org.apache.accumulo.core.tabletserver.thrift.ActiveCompaction> getActiveCompactions(org.apache.accumulo.core.securityImpl.thrift.TCredentials credentials) throws org.apache.accumulo.core.clientImpl.thrift.ThriftSecurityException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getRunningCompaction(org.apache.accumulo.core.securityImpl.thrift.TCredentials credentials, org.apache.thrift.async.AsyncMethodCallback<org.apache.accumulo.core.tabletserver.thrift.TExternalCompactionJob> resultHandler) throws org.apache.thrift.TException;

    public void getRunningCompactionId(org.apache.accumulo.core.securityImpl.thrift.TCredentials credentials, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException;

    public void getActiveCompactions(org.apache.accumulo.core.securityImpl.thrift.TCredentials credentials, org.apache.thrift.async.AsyncMethodCallback<java.util.List<org.apache.accumulo.core.tabletserver.thrift.ActiveCompaction>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public org.apache.accumulo.core.tabletserver.thrift.TExternalCompactionJob getRunningCompaction(org.apache.accumulo.core.securityImpl.thrift.TCredentials credentials) throws org.apache.accumulo.core.clientImpl.thrift.ThriftSecurityException, org.apache.thrift.TException
    {
      send_getRunningCompaction(credentials);
      return recv_getRunningCompaction();
    }

    public void send_getRunningCompaction(org.apache.accumulo.core.securityImpl.thrift.TCredentials credentials) throws org.apache.thrift.TException
    {
    ...
    public java.lang.String getRunningCompactionId(org.apache.accumulo.core.securityImpl.thrift.TCredentials credentials) throws org.apache.accumulo.core.clientImpl.thrift.ThriftSecurityException, org.apache.thrift.TException
    {
      send_getRunningCompactionId(credentials);
      return recv_getRunningCompactionId();
    }

    public void send_getRunningCompactionId(org.apache.accumulo.core.securityImpl.thrift.TCredentials credentials) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getRunningCompaction(org.apache.accumulo.core.securityImpl.thrift.TCredentials credentials, org.apache.thrift.async.AsyncMethodCallback<org.apache.accumulo.core.tabletserver.thrift.TExternalCompactionJob> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getRunningCompaction_call method_call = new getRunningCompaction_call(credentials, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public void getRunningCompactionId(org.apache.accumulo.core.securityImpl.thrift.TCredentials credentials, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getRunningCompactionId_call method_call = new getRunningCompactionId_call(credentials, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getRunningCompaction<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getRunningCompaction_args> {
      ...
      public getRunningCompaction_result getResult(I iface, getRunningCompaction_args args) throws org.apache.thrift.TException {
        getRunningCompaction_result result = new getRunningCompaction_result();
        try {
          result.success = iface.getRunningCompaction(args.credentials);
    ...
    public static class getRunningCompactionId<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getRunningCompactionId_args> {
      ...
      public getRunningCompactionId_result getResult(I iface, getRunningCompactionId_args args) throws org.apache.thrift.TException {
        getRunningCompactionId_result result = new getRunningCompactionId_result();
        try {
          result.success = iface.getRunningCompactionId(args.credentials);
        } catch (org.apache.accumulo.core.clientImpl.thrift.ThriftSecurityException sec) {
          result.sec = sec;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getRunningCompaction<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getRunningCompaction_args, org.apache.accumulo.core.tabletserver.thrift.TExternalCompactionJob> {
      ...
      public void start(I iface, getRunningCompaction_args args, org.apache.thrift.async.AsyncMethodCallback<org.apache.accumulo.core.tabletserver.thrift.TExternalCompactionJob> resultHandler) throws org.apache.thrift.TException {
        iface.getRunningCompaction(args.credentials,resultHandler);
      }
    }
    ...
    public static class getRunningCompactionId<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getRunningCompactionId_args, java.lang.String> {
      ...
      public void start(I iface, getRunningCompactionId_args args, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException {
        iface.getRunningCompactionId(args.credentials,resultHandler);
      }
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<org.apache.accumulo.core.tabletserver.thrift.ActiveCompaction>(_list38.size);
                  @org.apache.thrift.annotation.Nullable org.apache.accumulo.core.tabletserver.thrift.ActiveCompaction _elem39;
                  for (int _i40 = 0; _i40 < _list38.size; ++_i40)
                  {
                    _elem39 = new org.apache.accumulo.core.tabletserver.thrift.ActiveCompaction();
                    _elem39.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getActiveCompactions_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (org.apache.accumulo.core.tabletserver.thrift.ActiveCompaction _iter41 : struct.success)
            {
              _iter41.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (org.apache.accumulo.core.tabletserver.thrift.ActiveCompaction _iter42 : struct.success)
            {
              _iter42.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<org.apache.accumulo.core.tabletserver.thrift.ActiveCompaction>(_list43.size);
            @org.apache.thrift.annotation.Nullable org.apache.accumulo.core.tabletserver.thrift.ActiveCompaction _elem44;
            for (int _i45 = 0; _i45 < _list43.size; ++_i45)
            {
              _elem44 = new org.apache.accumulo.core.tabletserver.thrift.ActiveCompaction();
              _elem44.read(iprot);
