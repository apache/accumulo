...
public class TFateTransaction implements org.apache.thrift.TBase<TFateTransaction, TFateTransaction._Fields>, java.io.Serializable, Cloneable, Comparable<TFateTransaction> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TFateTransaction");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TFateTransactionStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TFateTransactionTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TFateTransaction.class, metaDataMap);
  }

  public TFateTransaction() {
  }
   ...
   */
  public TFateTransaction(TFateTransaction other) {
  ...
  public TFateTransaction deepCopy() {
    return new TFateTransaction(this);
  }
  ...
  public TFateTransaction setTxid(long txid) {
    this.txid = txid;
    setTxidIsSet(true);
    return this;
  }
  ...
  public TFateTransaction setTstatus(@org.apache.thrift.annotation.Nullable java.lang.String tstatus) {
    this.tstatus = tstatus;
    return this;
  }
  ...
  public TFateTransaction setDebug(@org.apache.thrift.annotation.Nullable java.lang.String debug) {
    this.debug = debug;
    return this;
  }
  ...
  public TFateTransaction setHlocks(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> hlocks) {
    this.hlocks = hlocks;
    return this;
  }
  ...
  public TFateTransaction setWlocks(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> wlocks) {
    this.wlocks = wlocks;
    return this;
  }
  ...
  public TFateTransaction setTop(@org.apache.thrift.annotation.Nullable java.lang.String top) {
    this.top = top;
    return this;
  }
  ...
  public TFateTransaction setTimecreated(long timecreated) {
    this.timecreated = timecreated;
    setTimecreatedIsSet(true);
    return this;
  }
  ...
  public TFateTransaction setStackInfo(@org.apache.thrift.annotation.Nullable java.lang.String stackInfo) {
    this.stackInfo = stackInfo;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof TFateTransaction)
      return this.equals((TFateTransaction)that);
    return false;
  }

  public boolean equals(TFateTransaction that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TFateTransaction other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetTstatus(), other.isSetTstatus());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTstatus()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetHlocks(), other.isSetHlocks());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHlocks()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetWlocks(), other.isSetWlocks());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWlocks()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetTimecreated(), other.isSetTimecreated());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTimecreated()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetStackInfo(), other.isSetStackInfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStackInfo()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TFateTransaction(");
    boolean first = true;
  ...
  private static class TFateTransactionStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFateTransactionStandardScheme getScheme() {
      return new TFateTransactionStandardScheme();
    }
  }

  private static class TFateTransactionStandardScheme extends org.apache.thrift.scheme.StandardScheme<TFateTransaction> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TFateTransaction struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFateTransaction struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TFateTransactionTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFateTransactionTupleScheme getScheme() {
      return new TFateTransactionTupleScheme();
    }
  }

  private static class TFateTransactionTupleScheme extends org.apache.thrift.scheme.TupleScheme<TFateTransaction> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TFateTransaction struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TFateTransaction struct) throws org.apache.thrift.TException {
