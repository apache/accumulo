...
public class TTabletRefresh implements org.apache.thrift.TBase<TTabletRefresh, TTabletRefresh._Fields>, java.io.Serializable, Cloneable, Comparable<TTabletRefresh> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TTabletRefresh");
  ...
  private static final org.apache.thrift.protocol.TField SCAN_ENTRIES_FIELD_DESC = new org.apache.thrift.protocol.TField("scanEntries", org.apache.thrift.protocol.TType.LIST, (short)2);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TTabletRefreshStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TTabletRefreshTupleSchemeFactory();

  public @org.apache.thrift.annotation.Nullable org.apache.accumulo.core.dataImpl.thrift.TKeyExtent extent; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> scanEntries; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.SCAN_ENTRIES, new org.apache.thrift.meta_data.FieldMetaData("scanEntries", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TTabletRefresh.class, metaDataMap);
  }
  ...
  public TTabletRefresh(TTabletRefresh other) {
    ...
    if (other.isSetScanEntries()) {
      java.util.List<java.lang.String> __this__scanEntries = new java.util.ArrayList<java.lang.String>(other.scanEntries);
  ...
  public TTabletRefresh setExtent(@org.apache.thrift.annotation.Nullable org.apache.accumulo.core.dataImpl.thrift.TKeyExtent extent) {
    this.extent = extent;
    return this;
  }
  ...
  public TTabletRefresh setScanEntries(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> scanEntries) {
    this.scanEntries = scanEntries;
    return this;
  }
  ...
  /** Returns true if field scanEntries is set (has been assigned a value) and false otherwise */
  ...
  public int compareTo(TTabletRefresh other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetScanEntries(), other.isSetScanEntries());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetScanEntries()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.scanEntries, other.scanEntries);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TTabletRefresh(");
    boolean first = true;
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("scanEntries:");
    if (this.scanEntries == null) {
      sb.append("null");
    } else {
      sb.append(this.scanEntries);
    }
    first = false;
    sb.append(")");
    return sb.toString();
  ...
  private static class TTabletRefreshStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
  ...
  private static class TTabletRefreshStandardScheme extends org.apache.thrift.scheme.StandardScheme<TTabletRefresh> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, TTabletRefresh struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.scanEntries = new java.util.ArrayList<java.lang.String>(_list72.size);
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, TTabletRefresh struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.scanEntries != null) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, struct.scanEntries.size()));
  ...
  private static class TTabletRefreshTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
  ...
  private static class TTabletRefreshTupleScheme extends org.apache.thrift.scheme.TupleScheme<TTabletRefresh> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TTabletRefresh struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TTabletRefresh struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.scanEntries = new java.util.ArrayList<java.lang.String>(_list77.size);
