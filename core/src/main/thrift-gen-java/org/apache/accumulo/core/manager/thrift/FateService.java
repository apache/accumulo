...
public class FateService {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class beginFateOperation<I extends Iface> extends org.apache.thrift.ProcessFunction<I, beginFateOperation_args, beginFateOperation_result> {
      ...
      @Override
      public beginFateOperation_result getEmptyResultInstance() {
        return new beginFateOperation_result();
      }

      @Override
      public beginFateOperation_result getResult(I iface, beginFateOperation_args args) throws org.apache.thrift.TException {
        beginFateOperation_result result = getEmptyResultInstance();
        try {
    ...
    public static class executeFateOperation<I extends Iface> extends org.apache.thrift.ProcessFunction<I, executeFateOperation_args, executeFateOperation_result> {
      ...
      @Override
      public executeFateOperation_result getEmptyResultInstance() {
        return new executeFateOperation_result();
      }

      @Override
      public executeFateOperation_result getResult(I iface, executeFateOperation_args args) throws org.apache.thrift.TException {
        executeFateOperation_result result = getEmptyResultInstance();
        try {
    ...
    public static class waitForFateOperation<I extends Iface> extends org.apache.thrift.ProcessFunction<I, waitForFateOperation_args, waitForFateOperation_result> {
      ...
      @Override
      public waitForFateOperation_result getEmptyResultInstance() {
        return new waitForFateOperation_result();
      }

      @Override
      public waitForFateOperation_result getResult(I iface, waitForFateOperation_args args) throws org.apache.thrift.TException {
        waitForFateOperation_result result = getEmptyResultInstance();
        try {
    ...
    public static class finishFateOperation<I extends Iface> extends org.apache.thrift.ProcessFunction<I, finishFateOperation_args, finishFateOperation_result> {
      ...
      @Override
      public finishFateOperation_result getEmptyResultInstance() {
        return new finishFateOperation_result();
      }

      @Override
      public finishFateOperation_result getResult(I iface, finishFateOperation_args args) throws org.apache.thrift.TException {
        finishFateOperation_result result = getEmptyResultInstance();
        try {
    ...
    public static class cancelFateOperation<I extends Iface> extends org.apache.thrift.ProcessFunction<I, cancelFateOperation_args, cancelFateOperation_result> {
      ...
      @Override
      public cancelFateOperation_result getEmptyResultInstance() {
        return new cancelFateOperation_result();
      }

      @Override
      public cancelFateOperation_result getResult(I iface, cancelFateOperation_args args) throws org.apache.thrift.TException {
        cancelFateOperation_result result = getEmptyResultInstance();
        try {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class beginFateOperation<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, beginFateOperation_args, TFateId, beginFateOperation_result> {
      public beginFateOperation() {
        super("beginFateOperation");
      }
    ...
    public static class executeFateOperation<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, executeFateOperation_args, Void, executeFateOperation_result> {
      public executeFateOperation() {
        super("executeFateOperation");
      }
    ...
    public static class waitForFateOperation<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, waitForFateOperation_args, java.lang.String, waitForFateOperation_result> {
      public waitForFateOperation() {
        super("waitForFateOperation");
      }
    ...
    public static class finishFateOperation<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, finishFateOperation_args, Void, finishFateOperation_result> {
      public finishFateOperation() {
        super("finishFateOperation");
      }
    ...
    public static class cancelFateOperation<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, cancelFateOperation_args, java.lang.Boolean, cancelFateOperation_result> {
      public cancelFateOperation() {
        super("cancelFateOperation");
      }
                ...
                if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                  {
                    ...
                    struct.arguments = new java.util.ArrayList<java.nio.ByteBuffer>(_list34.size);
                ...
                if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                  {
                    ...
                    struct.options = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map37.size);
                    ...
                    for (int _i40 = 0; _i40 < _map37.size; ++_i40)
                    {
                      ...
                      struct.options.put(_key38, _val39);
                    }
                    iprot.readMapEnd();
                  }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, executeFateOperation_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.arguments != null) {
          oprot.writeFieldBegin(ARGUMENTS_FIELD_DESC);
          {
            ...
            for (java.nio.ByteBuffer _iter41 : struct.arguments)
            {
        ...
        if (struct.options != null) {
          oprot.writeFieldBegin(OPTIONS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter42 : struct.options.entrySet())
            {
        ...
        if (struct.isSetArguments()) {
          {
            ...
            for (java.nio.ByteBuffer _iter43 : struct.arguments)
            {
        ...
        if (struct.isSetOptions()) {
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter44 : struct.options.entrySet())
            {
          ...
          if (incoming.get(4)) {
            {
              ...
              struct.arguments = new java.util.ArrayList<java.nio.ByteBuffer>(_list45.size);
              @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem46;
              for (int _i47 = 0; _i47 < _list45.size; ++_i47)
              {
                _elem46 = iprot.readBinary();
                struct.arguments.add(_elem46);
              }
            }
            struct.setArgumentsIsSet(true);
          }
          if (incoming.get(5)) {
            {
              ...
              struct.options = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map48.size);
