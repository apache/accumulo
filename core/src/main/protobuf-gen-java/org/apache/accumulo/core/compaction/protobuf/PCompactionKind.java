 ...
 * </pre>
 *
 * Protobuf enum {@code compaction_coordinator.PCompactionKind}
 */
public enum PCompactionKind
   ...
   * </pre>
   *
   * <code>CK_UNKNOWN = 0;</code>
   */
  CK_UNKNOWN(0),
  /**
   * <code>CK_SYSTEM = 1;</code>
   */
  CK_SYSTEM(1),
  /**
   * <code>CK_USER = 2;</code>
   ...
   * <code>CK_UNKNOWN = 0;</code>
   */
  public static final int CK_UNKNOWN_VALUE = 0;
  /**
   * <code>CK_SYSTEM = 1;</code>
   */
  public static final int CK_SYSTEM_VALUE = 1;
  /**
   * <code>CK_USER = 2;</code>
   */
  public static final int CK_USER_VALUE = 2;
  ...
  public static PCompactionKind forNumber(int value) {
    switch (value) {
      case 0: return CK_UNKNOWN;
      case 1: return CK_SYSTEM;
      case 2: return CK_USER;
      default: return null;
    }
  }
  ...
  // @@protoc_insertion_point(enum_scope:compaction_coordinator.PCompactionKind)
}
