...
public class StandaloneAccumuloClusterConfiguration extends AccumuloClusterPropertyConfiguration {
  ...
  public static final String ACCUMULO_STANDALONE_SERVER_CONF = ACCUMULO_STANDALONE_PREFIX
      + "server.conf";
  public static final String ACCUMULO_STANDALONE_CLIENT_CMD_PREFIX = ACCUMULO_STANDALONE_PREFIX
      + "client.cmd.prefix";
  public static final String ACCUMULO_STANDALONE_SERVER_CMD_PREFIX = ACCUMULO_STANDALONE_PREFIX
      + "server.cmd.prefix";
