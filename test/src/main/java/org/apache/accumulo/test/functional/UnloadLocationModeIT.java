...
public class UnloadLocationModeIT extends ConfigurableMacBase {
  ...
  public void configure(MiniAccumuloConfigImpl cfg, Configuration fsConf) {
    cfg.setProperty(Property.TSERV_LAST_LOCATION_MODE, "unload");
  }
  ...
  public void test() throws Exception {
    try (AccumuloClient c =
      ...
      // this would not be null if the mode were "assign"
      ...
      assertEquals("unload", c.instanceOperations().getSystemConfiguration()
      ...
      // This should give it a last location if the mode were "compact", but should not for
      // "assignment"
