  ...
  public void testHdfsConfigOverrides() throws Exception {
    try (AccumuloClient c = Accumulo.newClient().from(getClientProperties()).build()) {
      ...
      assertEquals("104857600", siteConfig
          .get(Property.GENERAL_ARBITRARY_PROP_PREFIX.getKey() + vol2 + ".dfs.blocksize"));
      assertEquals("true", siteConfig.get(Property.GENERAL_ARBITRARY_PROP_PREFIX.getKey() + vol1
          + ".dfs.client.use.datanode.hostname"));
      assertEquals("false", siteConfig.get(Property.GENERAL_ARBITRARY_PROP_PREFIX.getKey() + vol2
          + ".dfs.client.use.datanode.hostname"));
      assertEquals("0", siteConfig.get(Property.GENERAL_ARBITRARY_PROP_PREFIX.getKey() + vol1
          + ".dfs.client.hedged.read.threadpool.size"));
      assertEquals("1", siteConfig.get(Property.GENERAL_ARBITRARY_PROP_PREFIX.getKey() + vol2
          + ".dfs.client.hedged.read.threadpool.size"));
