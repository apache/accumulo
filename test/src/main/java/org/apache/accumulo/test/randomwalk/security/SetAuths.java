...
public class SetAuths extends Test {
  ...
  public void visit(State state, Properties props) throws Exception {
    ...
    boolean hasPermission = WalkingSecurity.get(state).canChangeAuthorizations(
        CredentialHelper.create(authPrincipal, authToken, state.getInstance().getInstanceID()), target);
