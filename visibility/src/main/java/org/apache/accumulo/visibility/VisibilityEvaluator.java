...
class VisibilityEvaluator {
   ...
   */
  private static class UnescapingAuthorizationContainer extends AuthorizationContainer {
   ...
   */
  public boolean evaluate(VisibilityExpressionImpl visibility) throws VisibilityParseException {
