...
public class FateCommand extends Command {
  ...
  public int execute(final String fullCommand, final CommandLine cl, final Shell shellState)
    ...
    if (cl.hasOption(cancel.getOpt())) {
      ...
      validateArgs(txids);
      failedCommand = deleteTx(shellState.getWriter(), admin, zs, zk, managerLockPath, tableLocksPath, txids);
  ...
  protected boolean deleteTx(PrintWriter out, AdminUtil<FateCommand> admin,
      ZooStore<FateCommand> zs, ZooReaderWriter zk, ServiceLockPath zLockManagerPath, ServiceLockPath zTableLocksPath, String[] args)
