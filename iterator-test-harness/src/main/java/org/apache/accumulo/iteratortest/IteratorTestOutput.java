...
/**
 * The expected results from invoking a {@link IteratorTestCase} on a {@link IteratorTestInput}. The output
 * will be either a {@link SortedMap} of Keys and Values or an exception but never both. If one of these members
 * is null, the other is guaranteed to be non-null.
 */
public class IteratorTestOutput {
   ...
   *
   * @param output The sorted collection of Key-Value pairs generated by an Iterator.
   */
