 ...
 * {@link AccumuloFileOutputFormatImpl#setOutputPath(Job, Path)}. This is inherited from
...
public class AccumuloFileOutputFormatImpl extends FileOutputFormat<Key,Value> {
   ...
   * @since 1.5.0
   */
  protected static void setCompressionType(Job job, String compressionType) {
   ...
   * @since 1.5.0
   */
  protected static void setDataBlockSize(Job job, long dataBlockSize) {
   ...
   * @since 1.5.0
   */
  protected static void setFileBlockSize(Job job, long fileBlockSize) {
   ...
   * @since 1.5.0
   */
  protected static void setIndexBlockSize(Job job, long indexBlockSize) {
   ...
   * @since 1.5.0
   */
  protected static void setReplication(Job job, int replication) {
  ...
  protected static void setSampler(Job job, SamplerConfiguration samplerConfig) {
   ...
   * @since 2.0.0
   */
  protected static void setSummarizers(Job job, SummarizerConfiguration... summarizerConfigs) {
