...
the changes to Thrift.  **NOTE:** Thrift 0.9.1 and Thrift 0.9.3 are not
compatible.  Applications running against Accumulo 1.8 with Thrift
0.9.1 will not work, so developers should upgrade to Thrift 0.9.3.
