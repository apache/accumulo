...
the changes to Thrift.  Users should note that Thrift 0.9.1 and Thrift
0.9.3 are not compatible, so applications running against Accumulo 1.8
with a Thrift 0.9.1 will not work.  Developers should upgrade to
Thrift 0.9.3.
