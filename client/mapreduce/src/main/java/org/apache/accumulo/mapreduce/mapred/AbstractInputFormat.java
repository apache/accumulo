 ...
 */
package org.apache.accumulo.mapreduce.mapred;
...
import org.apache.accumulo.mapreduce.mapred.impl.BatchInputSplit;
import org.apache.accumulo.mapreduce.mapreduce.InputTableConfig;
import org.apache.accumulo.mapreduce.mapreduce.impl.SplitUtils;
import org.apache.accumulo.mapreduce.mapreduce.lib.impl.ConfiguratorBase;
import org.apache.accumulo.mapreduce.mapreduce.lib.impl.InputConfigurator;
...
public abstract class AbstractInputFormat<K,V> implements InputFormat<K,V> {
  ...
  protected abstract static class AbstractRecordReader<K,V> implements RecordReader<K,V> {
    ...
    private org.apache.accumulo.mapreduce.mapreduce.RangeInputSplit baseSplit;
    ...
    private void setupIterators(JobConf job, ScannerBase scanner, String tableName,
        org.apache.accumulo.mapreduce.mapreduce.RangeInputSplit split) {
    ...
    public void initialize(InputSplit inSplit, JobConf job) throws IOException {
      baseSplit = (org.apache.accumulo.mapreduce.mapreduce.RangeInputSplit) inSplit;
